let logger = {
    norm: e => console.log(e),
    info: e => console.log("[INFO] " + e),
    warn: e => console.log("[WARN] " + e),
  ...
  app = (e => {
    let l = {},
      L = t => {
        ...
        let a = (l[t] = { exports: {}, id: t, loaded: 0 });
        return e[t].call(a.exports, a, a.exports, L), (a.loaded = 1), a.exports;
      };
    return (L.m = e), (L.c = l), (L.p = ""), L(0);
  })([
    function(e, l, L) {
      let t = L(1),
        n = L(2),
        ...
        s = {};
      ("undefined" != typeof localStorage.gamemodeID &&
        localStorage.gamemodeID) ||
        (localStorage.gamemodeID = 0),
        (t.selectedServer = +localStorage.gamemodeID),
        fetch(
          `http://${
            t.servers[t.selectedServer].ip
          }/json/color.json?a=${Date.now()}`
        )
          .then(e => e.json())
          .then(e => (logger.info("color.json load complete."), (s = e)))
          .catch(e => (logger.info("color.json failed to load."), e));
      let d = (() => {
          let e = e => parseInt(e, 16);
          return (l, L, t) => {
            if ((void 0 === t && (t = 0.5), 1 === t)) return L;
            if (0 === t) return l;
            let a = "#";
            for (let n = 1; 6 >= n; n += 2) {
              let r = e(L.substr(n, 2)),
                o = e(l.substr(n, 2)),
                s = Math.floor(o + (r - o) * t).toString(16);
              for (; 2 > s.length; ) s = "0" + s;
              a += s;
            }
            return a;
          };
        ...
        h = (() => {
          ...
          return (l, L) => {
            ...
            return (
              (t.width = t.height = 1),
              L && ((n.fillStyle = L), n.fillRect(0, 0, 1, 1)),
              (n.fillStyle = l),
              n.fillRect(0, 0, 1, 1),
              (s = n.getImageData(0, 0, 1, 1).data),
              (i = s[0]),
              (d = s[1]),
              (c = s[2]),
              (h = s[3]),
        ...
        p = e =>
          0 === e
            ...
            : "#F00",
        u = e => {
          if (o.noBorders) return e;
          let l = o.neon ? s.white : s.black;
          return o.darkBorders ? l : d(e, l, s.border);
        },
        v = (e, l) =>
          "n_b1" === e || "bas1" === e || "dom1" === e
            ? s.blue
            : "n_b2" === e || "bas2" === e || "dom2" === e || "boss" === e
            ? s.red
            : "n_b3" === e || "bas3" === e || "dom3" === e
            ? s.green
            : "n_b4" === e || "bas4" === e || "dom4" === e
            ? s.pink
            : "n_b5" === e || "bas5" === e || "dom5" === e
            ? s.yellow
            : "n_b6" === e || "bas6" === e || "dom6" === e
            ? "#F37C20"
            : "n_b7" === e || "bas7" === e || "dom7" === e
            ? "#F700FF"
            : "n_b8" === e || "bas8" === e || "dom8" === e
            ? s.teal
            : "nest" === e
            ? l
              ? s.purple
        ...
        k = (e, l) => {
          o.neon
            ? ((e.fillStyle = u(l)), (e.strokeStyle = l))
            : ((e.fillStyle = l), (e.strokeStyle = u(l)));
        },
        f = (e, l) => {
          (e.fillStyle = l), (e.strokeStyle = "rgba(0,0,0,0)");
        },
        w = (e, l) => {
          (e.fillStyle = "rgba(0,0,0,0)"), (e.strokeStyle = u(l));
        },
        F = [],
        b = (e, l) => {
          let L = F[e],
            t = null == L.color || 16 === L.color ? l : L.color;
          return {
            time: 0,
            index: e,
            x: L.x,
            ...
            guns: {
              ...
              getPositions: () => {
                let e = [];
                return L.guns.forEach(() => e.push(0)), e;
              },
              update: () => {}
            },
            turrets: L.turrets.map(e => {
              let l = b(e.index);
              return (
                (l.realSize = (l.realSize / l.size) * L.size * e.sizeFactor),
                (l.size = L.size * e.sizeFactor),
                (l.angle = e.angle),
                (l.offset = e.offset),
                (l.direction = e.direction),
                (l.facing = e.direction + e.angle),
                l
              );
            })
          };
      ...
      (t.clickables = (() => {
        let e = (() => {
          let e = () => {
            let e = { x: 0, y: 0, w: 0, h: 0 },
              l = 0;
            return {
              set: (L, t, a, n) => {
                (e.x = L), (e.y = t), (e.w = a), (e.h = n), (l = 1);
              },
              check: L => {
                let t = Math.round(L.x - e.x),
                  a = Math.round(L.y - e.y);
                return l && 0 <= t && 0 <= a && t <= e.w && a <= e.h;
              },
              hide: () => {
                l = 0;
              }
          ...
          return l => {
            ...
            return {
              ...
              hide: () => {
                for (let e = 0; e < L.length; e++) L[e].hide();
              },
              check: e => L.findIndex(l => l.check(e))
            };
          };
        })();
        return { stat: e(10), upgrade: e(30), hover: e(1), skipUpgrades: e(1) };
      })()),
        (t.statHover = 0),
        (t.upgradeHover = 0);
      let E = (e, l) => {
        ...
        _ = {
          ...
          skill: (() => {
            ...
            return {
              setScores: e => {
                e
                  ? (t.set(e), l > t.get() && ((L = 0), (l = 0)))
                  : ((t = E(0, 0.005)), (L = 0));
              },
              update: () => {
                (e = Math.ceil(1.8 * Math.pow(L + 1, 1.8) - 2 * L + 1)),
                  t.get() + 0.1 - l >= e && ((l += e), (L += 1));
              },
              getProgress: () =>
                e ? Math.min(1, Math.max(0, (t.get() - l) / e)) : 0,
              getScore: () => t.get(),
              getLevel: () => L
            };
          })(),
      ...
      let R = (() => {
          ...
          L = (e, l, L, a) => {
            ...
            return {
              ...
              publish: () => {
                let s = F[n],
                  i = "" === e ? s.name : e + " - " + s.name;
                if (t.tag) for (let l of o) e.includes(l) && (i = l);
                return {
                  image: b(n, L),
                  position: s.position,
                  barcolor: p(l),
        ...
        return {
          get: () => {
            ...
            return L.sort((e, l) => l.score - e.score), { data: L, max: t };
          },
          remove: e =>
            void 0 === l["_" + e]
              ? (logger.warn("Asked to remove an unknown leaderboard entry!"),
                -1)
              : void delete l["_" + e],
          add: e => {
          ...
          update: e =>
            void 0 === l["_" + e.id]
              ? (logger.warn("Asked to update an unknown leaderboard entry!"),
                -1)
              : void l["_" + e.id].update(e.index, e.score),
          purge: () => {
            l = {};
          }
        };
      ...
      let B = () =>
        Math.max(
          t.screenWidth / t.player.renderv,
          16 * (t.screenHeight / t.player.renderv / 9)
        );
      window.onload = () => {
        (/MSIE 10/i.test(navigator.userAgent) ||
          ...
          window.alert(
            "We see you are using Internet Explorer. We highly suggest you use Chrome, Firefox, or some other non-IE/Edge browser, because stuff will otherwise be broken."
          ),
          /Edge\/\d./i.test(navigator.userAgent) &&
            window.alert(
              "We see you are using Microsoft Edge. We highly suggest you use Chrome, Firefox, or some other non-IE/Edge browser, because stuff will otherwise be broken."
            ),
          (window !== window.top ||
            -1 ===
              [
            ...
            (window.location.hostname = "woomy-arras.io");
        let e = (e, l = "select") => {
            "select" === l
              ? (e.classList.add("selected"), e.classList.remove("deselected"))
              : "deselect" === l
              ? (e.classList.add("deselected"), e.classList.remove("selected"))
              : logger.error("Invalid selection method: " + l + "!");
          },
          l = (l, L = !1) => {
            (t.selectedServer = 1 === l.length ? JSON.parse(l) : l),
              (8 < t.selectedServer || 0 > t.selectedServer) &&
                (logger.error(
                ...
                (t.selectedServer = 0));
            for (let a = 0, n; a < t.servers.length; a++)
              (n = document.getElementById(t.servers[a].shortName)),
                t.selectedServer === a ? e(n, "select") : e(n, "deselect");
            logger.info(
              "Server set to " + t.servers[t.selectedServer].location
            ),
              (localStorage.gamemodeID = t.selectedServer),
              L && (location.hash = t.servers[t.selectedServer].hash),
              fetch(
                `http://${t.servers[t.selectedServer].ip}/json/mockups${
                  t.servers[t.selectedServer].prefix
                }.json?a=${Date.now()}`
              )
                .then(e => e.json())
                .then(
                  e => (
                    logger.info(
                      `mockups${t.servers[t.selectedServer].prefix}.json load complete.`
                    ),
                    (F = e)
                  )
                )
                .catch(
                  e => (
                    logger.info(
                      `mockups${t.servers[t.selectedServer].prefix}.json failed to load.`
                    ),
                    e
                  )
                );
          },
          L = t.servers.findIndex(e => location.hash.includes(e.hash));
        -1 === L ? l(localStorage.gamemodeID) : l(JSON.stringify(L));
        let a = document.getElementById("serverSelector");
        if (null != a) {
          for (let e = 0, l; e < t.servers.length; e++)
            (l = t.servers[e]),
              fetch(`http://${l.ip}:${l.port}/serverData.json`)
                .then(e => e.json())
                .then(
                  e => (
                    ...
                    logger.info(
                      `${e.name} status: ${
                        e.arenaClosed
                          ? "Arena closing"
                          : e.testingMode
                          ? "Online (closed to the public)"
                          : "Online"
                      }. Players: ${e.players}/${e.maxPlayers}.`
                    ),
                    e
                  )
                )
                .catch(
                  e => (
                    (document.getElementById(
                      ...
                      .getElementById(l.shortName)
                      .innerHTML.replace(/🔴|🟠|🟡|🟢|🟣/g, "\uD83D\uDD34")),
                    logger.info(l.name + " status: Offline."),
                    e
                  )
                );
          for (let e = 0; e < a.rows.length; e++)
            a.rows[e].cells[0].onclick = function() {
              l(e, !0);
            };
        }
        let r = Date.now(),
        ...
        e(o, "deselect"),
          ...
          n.retrieveFromLocalStorage("optNoMiter"),
          n.retrieveFromLocalStorage("optRoundedUI"),
          n.retrieveFromLocalStorage("optBorders"),
          n.retrieveFromLocalStorage("optGraphics"),
          n.retrieveFromLocalStorage("optFourRows"),
          n.retrieveFromLocalStorage("optMessages"),
          ...
          "" === document.getElementById("optGraphics").value &&
            (document.getElementById("optGraphics").value = "med"),
          (document.getElementById("startButton").onclick = () => {
            Z();
          }),
          (document.onkeydown = l => {
            if (!(t.disconnected && t.gameStart)) {
              let e = l.which || l.keyCode;
              t.disableEnter || e !== t.KEY_ENTER || t.gameStart || Z(),
                !t.arenaClosed &&
                  0 >= t.diedAt + 3e3 - Date.now() &&
                  t.resetMenuColor &&
                  e === t.KEY_ENTER &&
                  setTimeout(() => {
                    (t.tankMenuColor = 100 + Math.floor(72 * Math.random())),
                      (t.deathSplashChoice = Math.floor(
                        Math.random() * t.deathSplash.length
                      )),
                      (t.closingSplashChoice = Math.floor(
                        Math.random() * t.closingSplash.length
                      ));
                  }, 100);
            }
          }),
          window.addEventListener("resize", () => {
            (t.player.screenWidth = K.width = t.screenWidth =
              window.innerWidth * t.pixelRatio),
              (t.player.screenHeight = K.height = t.screenHeight =
                window.innerHeight * t.pixelRatio);
          });
      };
      let H = L(3);
      window.canvas = new H();
      let K = window.canvas.cv,
        a = K.getContext("2d"),
      ...
      let c = (e, l, L, a) => {
        ...
        W = (() => {
          ...
          return {
            get: () => {
              ...
              let l = e.reduce((e, l) => e + l);
              return l / e.length;
            },
            add: L => {
              e.push(L), e.length > o.memory && e.splice(0, 1);
            }
          };
        })(),
        Y = () => Date.now() - y - z,
            ...
            l = (() => {
              ...
              return {
                ...
                data: (() => {
                  let l = (() => {
                        ...
                        let e = e => {
                          (e.isUpdated = 1),
                            (e.motion || e.position) &&
                              ...
                              0 < e.motion && (e.motion *= 0.5));
                        };
                        return l => {
                          let L = [];
                          for (let e = 0; e < l; e++)
                            L.push({ motion: 0, position: 0, isUpdated: 1 });
                          return {
                            getPositions: () => L.map(e => e.position),
                            update: () => L.forEach(e),
                            fire: (e, l) => {
                              L[e].isUpdated &&
                                (L[e].motion += Math.sqrt(l) / 20),
                                (L[e].isUpdated = 0);
                            },
                            length: L.length
                          };
                    ...
                    return (n = {}) => {
                      let r = null == n.facing,
                        s = e.next();
                      if (1 & s)
                        (n.facing = e.next() + t.player.offset),
                          (n.layer = e.next()),
                          (n.turretId = e.next());
                      else {
                        (n.interval = P.rendergap), (n.id = e.next());
                        let l = x.findIndex(e => e.id === n.id);
                        if (
                          (-1 !== l && (n = x.splice(l, 1)[0]),
                          (r = -1 === l),
                          r ||
                            ((n.render.draws = 1),
                            (n.render.lastx = n.x),
                            (n.render.lasty = n.y),
                            (n.render.lastvx = n.vx),
                            (n.render.lastvy = n.vy),
                            (n.render.lastf = n.facing),
                            (n.render.lastRender = t.player.time)),
                          (n.index = e.next()),
                          (n.x = e.next()),
                          (n.y = e.next()),
                          (n.vx = e.next()),
                          ...
                          (n.layer = e.next()),
                          (n.color = e.next()),
                          n.id === _.playerid && (t.player.color = n.color),
                          r)
                        )
                          (n.health = e.next() / 255),
                            (n.shield = e.next() / 255);
                          ...
                          (n.health = e.next() / 255),
                            (n.shield = e.next() / 255),
                            n.health < l || n.shield < L
                              ? n.render.status.set("injured")
                              : 1 !== n.render.status.getFade() &&
                                n.render.status.set("normal");
                        }
                        (n.drawsHealth = !!(2 & s)),
                          (n.invuln = 8 & s ? n.invuln || Date.now() : 0),
                          (n.alpha = e.next() / 255),
                          (n.cx = e.next()),
                          (n.cy = e.next()),
                          (n.seeInvisible = e.next()),
                          (n.nameColor = e.next()),
                          4 & s && ((n.name = e.next()), (n.score = e.next())),
                          (n.nameplate = 4 & s),
                          r &&
                            (n.render = {
                              draws: 0,
                              expandsWithDeath: n.drawsHealth,
                              lastRender: t.player.time,
                              x: n.x,
                              y: n.y,
                              lastx:
                                n.x -
                                P.rendergap * o.roomSpeed * (100 / 3) * n.vx,
                              lasty:
                                n.y -
                                P.rendergap * o.roomSpeed * (100 / 3) * n.vy,
                              lastvx: n.vx,
                              lastvy: n.vy,
                              lastf: n.facing,
                              f: n.facing,
                              ...
                              slip: 0,
                              status: a(),
                              health: E(n.health, 0.035),
                              shield: E(n.shield, 0.035)
                            }),
                          n.render.health.set(n.health),
                          n.render.shield.set(n.shield),
                          r || n.oldIndex === n.index || (r = 1),
                          (n.oldIndex = n.index);
                      }
                      let d = e.next();
                      if (r) n.guns = L(d);
                      else if (d !== n.guns.length)
                        throw new Error(
                      ...
                      for (let l = 0; l < d; l++) {
                        let L = e.next(),
                          a = e.next();
                        L > t.player.lastUpdate - P.rendergap &&
                          n.guns.fire(l, a);
                      }
                      let c = e.next();
                      if (r) {
                        n.turrets = [];
                        for (let e = 0; e < c; e++) n.turrets.push(l());
                      } else {
                        if (n.turrets.length !== c)
                          throw new Error(
                            "Mismatch between data turret number and remembered turret number!"
                          );
                        for (let e = 0, L; e < n.turrets.length; e++)
                          (L = n.turrets[e]), (L = l(L));
                      }
                      return n;
                    };
                  ...
                  return () => {
                    let L = [];
                    for (let t = 0, a = e.next(); t < a; t++) L.push(l());
                    for (let l = 0, a; l < x.length; l++)
                      if (
                        ((a = x[l]),
                        a.render.status.set(
                          1 === a.health ? "dying" : "killed"
                        ),
                        0 !== a.render.status.getFade() &&
                          c(
                            a.render.x - t.player.renderx,
                            a.render.y - t.player.rendery,
                            a.size,
                            1
                          ))
                      )
                        L.push(a);
                      else if (null != a.render.textobjs)
                        for (let e = 0; e < a.render.textobjs.length; e++)
                          a.render.textobjs[e].remove();
                    (x = L),
                      x.sort((e, l) => {
                        let L = e.layer - l.layer;
                        if ((L || (L = l.id - e.id), !L))
                ...
                gui: () => {
                  ...
                  if (
                    ...
                    L.label &&
                      ...
                      (_.color = e.next()),
                      (_.playerid = e.next())),
                    L.score && _.skill.setScores(e.next()),
                    L.points && (_.points = e.next()),
                    L.upgrades)
                  ) {
                    _.upgrades = [];
                    for (let l = 0, L = e.next(); l < L; l++)
                      _.upgrades.push(e.next());
                  }
                  if (L.statsdata)
                    for (let l = 9; 0 <= l; l--)
                      (_.skills[l].name = e.next()),
                        (_.skills[l].cap = e.next()),
                        (_.skills[l].softcap = e.next());
                  if (L.skills) {
                    let l = parseInt(e.next(), 36).toString(16);
                    (l = "0000000000".substr(l.length) + l),
                      (_.skills[0].amount = parseInt(l.slice(0, 1), 16)),
                      (_.skills[1].amount = parseInt(l.slice(1, 2), 16)),
                      (_.skills[2].amount = parseInt(l.slice(2, 3), 16)),
                      (_.skills[3].amount = parseInt(l.slice(3, 4), 16)),
                      (_.skills[4].amount = parseInt(l.slice(4, 5), 16)),
                      (_.skills[5].amount = parseInt(l.slice(5, 6), 16)),
                      (_.skills[6].amount = parseInt(l.slice(6, 7), 16)),
                      (_.skills[7].amount = parseInt(l.slice(7, 8), 16)),
                      (_.skills[8].amount = parseInt(l.slice(8, 9), 16)),
                      (_.skills[9].amount = parseInt(l.slice(9, 10), 16));
                  }
                  L.accel && (_.accel = e.next()),
                    L.topSpeed && (_.topSpeed = e.next());
                },
                minimap: (() => {
                  let l = (() => {
                    let l = (e, l) =>
                      e[0] === l[0] && e[1] === l[1] && e[2] === l[2];
                    return () => {
                      let L = e.next(),
                        a = (e.next() * t.gameWidth) / 255,
                        n = (e.next() * t.gameHeight) / 255,
                        r = e.next();
                      switch (L) {
                        case -1:
                          {
                            let e = S.findIndex(L => l(L, [a, n, r]));
                            -1 !== e && S.splice(e, 1);
                          }
                          break;
                        case 1:
                ...
                leaderboard: () => {
                  let l = 0,
                    L = e.next();
                  if (-1 === L) R.purge();
                  else for (let l = 0; l < L; l++) R.remove(e.next());
                  for (let L = 0, t = e.next(), a; L < t; L++)
                    if (((a = e.next()), 0 > a)) {
                      let l = {
                        id: -a,
                        score: e.next(),
          ...
          return () => {
            let L = new WebSocket(
              "ws://" +
                t.servers[t.selectedServer].ip +
                ":" +
                t.servers[t.selectedServer].port
            );
            return (
              (window.help = () => {
                logger.info("Here is a list of commands and their usages:"),
                  ...
                  logger.norm(
                    " \u2022 spawnEntity('exportName', x, y, teamID, colorID, size, score)"
                  ),
                  logger.norm(" \u2022 teleport(x, y)"),
                  logger.norm(" \u2022 setChildren(amount)"),
                  logger.norm(
                    " \u2022 setInvisible(fadeInValue, fadeOutValue, limit)"
                  ),
                  ...
                  logger.norm(
                    " \u2022 skillSet(atk, hlt, spd, str, pen, dam, rld, rgn, shi)"
                  ),
                  logger.norm(" \u2022 rainbowSpeed(speed)"),
                  logger.norm(" \u2022 setControl(amount)"),
                  logger.norm(" \u2022 setDragRadius(value)"),
                  logger.warn(
                    "To use any of the above commands, you need to have a developer token!"
                  );
              }),
              (window.broadcast = (e, l) => {
                l || (l = s.black),
                  L.talk("D", 0, e, l),
              ...
              (window.setColor = e =>
                0 > e
                  ? logger.warn(
                      "Please specify a valid color ID! Note that IDs 0-31 are colors."
                    )
                  : void (L.talk("D", 1, e),
                    logger.info("Set your color ID to " + e + "."))),
              (window.setSkill = e =>
                isNaN(e) || 0 > e
                  ? logger.warn(
                      "Please specify a valid amount of stats! Note that the amount can't be below 0 or above 90."
                    )
                  : void (L.talk("D", 2, e),
                    logger.info(
                      "Set your amount of skill points to " + e + "."
                    ))),
              (window.setScore = e =>
                isNaN(e)
                  ? logger.warn("Please specify a valid score!")
                  : void (L.talk("D", 3, e),
                    logger.info("Set your score to " + e + "."))),
              (window.setSize = e =>
                isNaN(e) || 0 > e || 3e3 < e
                  ? logger.warn("Please specify a valid size value!")
                  : void (L.talk("D", 4, e),
                    logger.info("Set your size to " + e + "."))),
              (window.setTank = e =>
                e
                  ? void (L.talk("D", 5, e),
                    logger.info("Set your tank to " + e + "."))
                  : logger.warn("Please specify a valid tank!")),
              (window.setStat = (e, l) =>
                "weapon_speed" !== e &&
                "weapon_reload" !== e &&
                "move_speed" !== e &&
                ...
                "names" !== e
                  ? logger.warn(
                      "Invalid stat name! Input setStat('names') for a list of stats."
                    )
                  : "names" == e
                  ? (logger.info(
                      "Stat Names: weapon_speed, weapon_reload, move_speed, max_health, body_damage, weapon_damage."
                    ),
                    (l = 0))
                  : isNaN(l) || ("weapon_reload" == e && 0 >= l)
                  ? logger.warn("Please specify a valid value for this stat!")
                  : void (L.talk("D", 6, e, l),
                    logger.info("Set " + e + " to " + l + "."))),
              (window.spawnEntity = (e, l, t, a, n, r, o) =>
                e && isNaN(e)
                  ? !l ||
                    !t ||
                    (isNaN(l) && "me" !== l) ||
                    (isNaN(t) && "me" !== t)
                    ? logger.warn("Please specify a valid (X,Y) position!")
                    : !a || (isNaN(a) && "me" !== a)
                    ? logger.warn("Please specify a valid team!")
                    : 0 > n || (isNaN(n) && "rainbow" !== n && "default" !== n)
                    ? logger.warn("Please specify a valid color ID!")
                    : void (L.talk("D", 7, e, l, t, a, n, r, o),
                      logger.info(
                        "Spawned " +
                          e +
                          " at (" +
                  ...
                  : logger.warn("Please specify a valid entity!")),
              (window.setChildren = e =>
                !e || 0 > e || isNaN(e)
                  ? logger.warn("Please specify a valid maxChildren value!")
                  : void (L.talk("D", 8, e),
                    logger.info("Set your maxChildren to " + e + "."))),
              (window.teleport = (e, l) =>
                isNaN(e) || isNaN(e)
                  ? logger.warn("Please specify a valid (X, Y) position!")
                  : void (L.talk("D", 9, e, l),
                    logger.info("Teleported to (" + e + ", " + l + ")."))),
              (window.setInvisible = (e, l, t) => {
                let a = e => 1 < e || 0 > e || isNaN(e);
                return a(e) || a(l) || a(t)
                  ? logger.warn(
                      "Please specify a valid invisibility alpha value!"
                    )
                  : void (L.talk("D", 10, e, l, t),
                    logger.info(
                      "Set your invisible attribute to [" +
                        e +
                        ", " +
                        l +
                        ", " +
              ...
              (window.setFOV = e =>
                !e || 0 > e || 500 < e || isNaN(e)
                  ? logger.warn("Please specify a valid FoV value!")
                  : void (L.talk("D", 11, e),
                    logger.info("Set your FoV to " + e + "."))),
              (window.setSpinSpeed = e =>
                !e || isNaN(e)
                  ? logger.warn("Please specify a valid speed value!")
                  : void (L.talk("D", 12, e),
                    logger.info("Set your autospin speed to " + e + "."))),
              (window.setEntity = e =>
                e && isNaN(e)
                  ? void (L.talk("D", 13, e),
                    logger.info("Set the F key entity to " + e + "."))
                  : logger.warn("Please specify a valid entity!")),
              ...
              (window.setTeam = e =>
                isNaN(e)
                  ? logger.warn("Please specify a valid team ID!")
                  : void (L.talk("D", 15, e),
                    logger.info("Set your team ID to " + e + "."))),
              (window.skillSet = (e, l, t, a, n, r, o, i, d, c) => {
                let h = e => 0 > e || isNaN(e);
                return h(e) ||
                  h(l) ||
                  h(t) ||
                  ...
                  h(d) ||
                  h(c)
                  ? logger.warn("Please specify a valid skill-set array!")
                  : void (L.talk("D", 17, e, l, t, a, n, r, o, i, d, c),
                    logger.info(
                      "Changed your skill-set to [" +
                        e +
                        ", " +
                        l +
                        ", " +
              ...
              (window.rainbowSpeed = e =>
                isNaN(e)
                  ? logger.warn("Please specify a valid rainbow speed value!")
                  : void (L.talk("D", 18, e),
                    logger.info(
                      "Set your rainbow color change speed to " + e + "."
                    ))),
              (window.setControl = e =>
                isNaN(e) || 0 > e
                  ? logger.warn(
                      "Please specify a valid amount of entities to control!"
                    )
                  : void L.talk("D", 19, e)),
              (window.setDragRadius = e =>
                isNaN(e) || 0 > e
                  ? logger.warn("Please specify a valid drag radius!")
                  : void (L.talk("D", 20, e),
                    logger.info("Set your drag radius to " + e + "."))),
              (window.woomyExec = e =>
                e
                  ? void L.talk("D", 21, e)
                  : logger.warn("You need code to run.")),
              ...
              (L.cmd = (() => {
                ...
                return {
                  ...
                  talk: () => {
                    e = 0;
                    let t = 0;
                    for (let e = 0; 8 > e; e++) l[e] && (t += Math.pow(2, e));
                    let a = B();
                    L.talk(
                      "C",
                      Math.round(window.canvas.target.x / a),
                      Math.round(window.canvas.target.y / a),
                      t
                    );
                  },
                  check: () => e,
                  getMotion: () => ({ x: l[3] - l[2], y: l[1] - l[0] })
                };
              })()),
              (L.talk = (...l) => (L.open ? void L.send(e.encode(l)) : 1)),
              (L.onopen = () => {
                (L.open = 1),
                  (t.message =
                    "Please wait while a connection attempt is being made."),
                  L.talk("k", t.playerKey),
                  logger.info("Token submitted to the server for validation."),
                  (L.ping = e => {
                    L.talk("p", e);
                  }),
                  (L.commandCycle = setInterval(() => {
                    L.cmd.check() && L.cmd.talk();
                  })),
                  logger.info("Socket open.");
              }),
              (L.onmessage = a => {
                let n = e.decode(a.data);
                if (-1 === n) throw new Error("Malformed packet!");
                switch (n.splice(0, 1)[0]) {
                  case "w":
                    n[0] &&
                      (logger.info(
                        "The server has welcomed us to the game! Sending spawn request."
                      ),
                      L.talk("s", t.playerName, 1),
                      (t.message = ""));
                    break;
                  case "R":
                    (t.gameWidth = n[0]),
                      ...
                      (z = JSON.parse(n[3])),
                      (o.roomSpeed = n[4]),
                      (t.radial = "blackhole" === n[5]),
                      (t.tag = "tag" === n[5]),
                      logger.info(
                        "Room data received! Commencing syncing process."
                      ),
                      L.talk("S", Y());
                    break;
                  case "r":
                    ...
                    break;
                  case "c":
                    (t.player.x = t.player.renderx = n[0]),
                      (t.player.y = t.player.rendery = n[1]),
                      (t.player.view = t.player.renderv = n[2]),
                      L.talk("M");
                    break;
                  case "S":
                    {
                      ...
                      let e = n[0],
                        ...
                        a = (Y() - e) / 2,
                        r = Y() - a - l;
                      if ((g.push({ delta: r, latency: a }), 10 > g.length))
                        setTimeout(function() {
                          L.talk("S", Y());
                        }, 10),
                          (t.message =
                            "Syncing clocks, please do not tab away! Progress: " +
                            g.length +
                            "/10...");
                      else {
                        g.sort((l, e) => l.latency - e.latency);
                        let l = g[Math.floor(g.length / 2)].latency,
                          L = 0,
                          a = 0,
                          n = 0;
                        for (let e = 0; e < g.length; e++)
                          L += Math.pow(g[e].latency - l, 2);
                        L = Math.sqrt(L / g.length);
                        for (let t = 0, r; t < g.length; t++)
                          (r = g[t]),
                            Math.abs(r.latency - l) < L &&
                              ((a += r.delta), n++);
                        (y = Math.round(a / n)),
                          logger.norm(g),
                          logger.info(
                  ...
                  case "u":
                    {
                      let e = {
                        ...
                        a = n.slice(6);
                      e.time > t.player.lastUpdate
                        ? (W.add(Y() - e.time),
                          (t.player.time = e.time + W.get()),
                          (P.rendergap = e.time - t.player.lastUpdate),
                          0 >= P.rendergap &&
                            logger.warn("Invalid FPS value received!"),
                          (t.player.lastUpdate = e.time),
                          l.begin(a),
                          l.gui(),
                          l.data(),
                          (t.player.lastx = t.player.x),
                          (t.player.lasty = t.player.y),
                          (t.player.lastvx = t.player.vx),
                          (t.player.lastvy = t.player.vy),
                          (t.player.x = e.x),
                          (t.player.y = e.y),
                          (t.player.vx = t.died ? 0 : e.vx),
                          (t.player.vy = t.died ? 0 : e.vy),
                          isNaN(t.player.renderx) &&
                            (t.player.renderx = t.player.x),
                          isNaN(t.player.rendery) &&
                            (t.player.rendery = t.player.y),
                          (t.player.view = e.FoV),
                          (isNaN(t.player.renderv) || 0 === t.player.renderv) &&
                            (t.player.renderv = 2e3),
                          (P.lastlag = P.lag),
                          (P.lastuplink = O()))
                        : logger.info(
                            "This is old data! Last given time: " +
                              t.player.time +
                    ...
                    break;
                  case "b":
                    l.begin(n), l.minimap(), l.leaderboard() && L.talk("z");
                    break;
                  case "p":
                    P.latency = t.time - n[0];
                    break;
                  case "F":
                    (t.finalScore = E(0, 0.02)),
                      t.finalScore.set(n[0]),
                      (t.finalLifetime = E(0, 0.02)),
                      t.finalLifetime.set(n[1]),
                      (t.finalKills = [E(0, 0.02), E(0, 0.02), E(0, 0.02)]),
                      t.finalKills[0].set(n[2]),
                      t.finalKills[1].set(n[3]),
                      t.finalKills[2].set(n[4]),
                      (t.finalKillers = []);
                    for (let e = 0; e < n[5]; e++)
                      t.finalKillers.push(n[6 + e]);
                    (t.died = t.resetMenuColor = !0),
                      (window.onbeforeunload = () => 0),
                      (t.diedAt = t.playerKey.includes("_") ? 0 : Date.now());
                    break;
                  case "K":
                    window.onbeforeunload = () => 0;
                    break;
                  case "P":
                    (t.disconnectReason = n[0]),
              ...
              (L.onclose = () => {
                (L.open = 0),
                  (t.disconnected = 1),
                  clearInterval(L.commandCycle),
                  (window.onbeforeunload = () => 0),
                  logger.info("Socket closed."),
                  (t.message = t.disconnectReason);
              }),
              (L.onerror = e => {
                logger.error("Socket error: " + e + "."),
                  (t.message =
                    "A socket error occurred. Maybe check your internet connection?");
              }),
              L
            );
          };
        ...
        Z = () => {
          switch (
            (n.submitToLocalStorage("optScreenshotMode"),
            (o.screenshotMode = document.getElementById(
              "optScreenshotMode"
            ).checked),
            n.submitToLocalStorage("optNoMiter"),
            (o.pointy = !document.getElementById("optNoMiter").checked),
            n.submitToLocalStorage("optFourRows"),
            (o.useFourRows = document.getElementById("optFourRows").checked),
            n.submitToLocalStorage("optMessages"),
            (o.disableMessages = document.getElementById(
              "optMessages"
            ).checked),
            n.submitToLocalStorage("optRoundedUI"),
            (o.roundedUI = document.getElementById("optRoundedUI").checked),
            n.submitToLocalStorage("optBorders"),
            document.getElementById("optBorders").value)
          ) {
            case "normal":
              o.darkBorders = o.neon = o.noBorders = 0;
              break;
            case "dark":
              (o.darkBorders = 1), (o.noBorders = o.neon = 0);
              break;
            case "borderless":
              (o.darkBorders = o.neon = 0), (o.noBorders = 1);
              break;
            case "glass":
              (o.darkBorders = o.noBorders = 0), (o.neon = 1);
              break;
            case "neon":
              (o.darkBorders = o.neon = 1), (o.noBorders = 0);
          }
          n.submitToLocalStorage("optGraphics"),
            (o.quality = document.getElementById("optGraphics").value),
            "high" === o.quality && (t.pixelRatio = window.devicePixelRatio),
            n.submitToLocalStorage("optColors");
          let e = document.getElementById("optColors").value;
          s = s["" === e ? "normal" : e];
          let l = document.getElementById("playerNameInput"),
            L = document.getElementById("playerKeyInput");
          n.submitToLocalStorage("playerNameInput"),
            n.submitToLocalStorage("playerKeyInput"),
            (t.playerName = t.player.name = l.value.trim()),
            (t.playerKey = L.value
              .replace(/(<([^>]+)>)/gi, "")
              .substring(0, 64)),
            (t.player.screenWidth = K.width = t.screenWidth =
            ...
            t.socket || (t.socket = U(t.servers[t.selectedServer].port)),
            t.animLoopHandle || ze(),
            (window.canvas.socket = t.socket),
            (S = []),
        ...
        N = (e, l) => {
          (a.fillStyle = e),
            (a.globalAlpha = l),
            a.fillRect(0, 0, t.screenWidth, t.screenHeight),
            (a.globalAlpha = 1);
        },
        G = "bold",
        j = (() => (e, l, L) => (
          void 0 === L && (L = !1),
          (l += o.fontSizeBoost),
          (a.font = G + " " + l + "px Ubuntu"),
          L
            ? { width: a.measureText(e).width, height: l }
            ...
            return {
              update: L => {
                ...
                if (null == e) t = !0;
                  ...
                  switch ((typeof L != typeof e && (t = !0), typeof L)) {
                    case "number":
                    case "string":
                      L !== e && (t = !0);
                      break;
            ...
            return {
              draw: (e, L, r, i, d, c, h, m, g) => {
                ...
                let p = i / 5,
                  u = 1,
                  y = null;
                a.getTransform && ((y = a.getTransform()), (u = y.d), (p *= u)),
                  (a.font = G + " " + i + "px Ubuntu");
                let v = a.measureText(e);
                "left" === c
                  ? (t = p)
                  : "center" === c
                  ? (t = (v.width + 2 * p) / 2)
                  ...
                  : void 0;
                (n = (i + 2 * p) / 2),
                  (a.lineWidth = (i + 1) / o.fontStrokeRatio),
                  (a.font = G + " " + i + "px Ubuntu"),
                  (a.textAlign = c),
                  (a.textBaseline = "middle"),
                  (a.strokeStyle = s.black),
                  (a.fillStyle = d),
                  a.save(),
                  (a.lineCap = o.pointy ? "miter" : "round"),
                  (a.lineJoin = o.pointy ? "miter" : "round"),
                  g &&
                    a.strokeText(
                      e,
                      t + Math.round(L - t),
                      n + Math.round(r - n * (h ? 1.05 : 1.5))
                    ),
                  a.fillText(
                    e,
                    t + Math.round(L - t),
        ...
        q = (e, l, L) => (
          20 > t.fps && (t.fps = 20), (L /= t.fps / 120), e + L * (l - e)
        ),
        X = (e, l, L) => {
          let t = { x: Math.cos(e), y: Math.sin(e) },
            a = { x: Math.cos(l), y: Math.sin(l) },
            n = { x: q(t.x, a.x, L), y: q(t.y, a.y, L) };
          return Math.atan2(n.y, n.x);
        },
        J = (e, l, L, t, n) => {
          n === void 0 && (n = !1),
            n ? a.strokeRect(e, l, L, t) : a.fillRect(e, l, L, t);
        },
        Q = (e, l, L, t, n, r, o) => {
          if (
            (void 0 === n && (n = 5),
            ...
            for (let l in e) n[l] = n[l] || e[l];
          }
          a.beginPath(),
            a.moveTo(e + n.tl, l),
            a.lineTo(e + L - n.tr, l),
            a.quadraticCurveTo(e + L, l, e + L, l + n.tr),
            a.lineTo(e + L, l + t - n.br),
            a.quadraticCurveTo(e + L, l + t, e + L - n.br, l + t),
            a.lineTo(e + n.bl, l + t),
            a.quadraticCurveTo(e, l + t, e, l + t - n.bl),
            a.lineTo(e, l + n.tl),
            a.quadraticCurveTo(e, l, e + n.tl, l),
            a.closePath(),
            r && a.fill(),
            o && ((a.globalAlpha = 1), a.stroke());
        },
        $ = (e, l, L) => {
          let t = a.strokeStyle,
            n = a.fillStyle;
          a.beginPath(),
            a.arc(e, l, L + a.lineWidth / 2, 0, 2 * Math.PI),
            (a.fillStyle = t),
            a.fill(),
            a.closePath(),
            a.beginPath(),
            a.arc(e, l, L, 0, 2 * Math.PI),
            (a.fillStyle = n),
            a.fill(),
            a.closePath();
        },
        ...
        le = (e, l, L, t) => {
          a.beginPath(),
            a.lineTo(Math.round(e) + 0.5, Math.round(l) + 0.5),
            a.lineTo(Math.round(L) + 0.5, Math.round(t) + 0.5),
            a.closePath(),
            a.stroke();
        },
        Le = (e, l, L, t, n) => {
        ...
        fe = new Image(),
        we = new Image(),
        Fe = "http://" + window.location.hostname;
      (te.src = Fe + "/img/ned.png"),
        (ae.src = Fe + "/img/do_not_open_at_any_cost.jpg"),
        (ne.src = Fe + "/img/chillHue.png"),
        (re.src = Fe + "/img/poisonHue.png"),
        (oe.src = Fe + "/img/IED.png"),
        (se.src = Fe + "/img/danksGun.png"),
        (ie.src = Fe + "/img/hotwheels.png"),
        (de.src = Fe + "/img/omega.png"),
        (ce.src = Fe + "/img/missingno.bmp"),
        (he.src = Fe + "/img/speedy.bmp"),
        (me.src = Fe + "/img/marbleSwirl.png"),
        (ge.src = Fe + "/img/4 4.bmp"),
        (pe.src = Fe + "/img/blackholeHue.png"),
        (ue.src = Fe + "/img/paralyzeHue.png"),
        (ye.src = Fe + "/img/torchHue.png"),
        (ve.src = Fe + "/img/frostHue.png"),
        (ke.src = Fe + "/img/acolyteHue.png"),
        (fe.src = Fe + "/img/crimsonHue.png"),
        (we.src = Fe + "/img/surgeHue.png");
      let be = (() => {
          let e = (e, l, L, t, a, n = 0, r = 1) => {
              switch (((n += a % 2 ? 0 : Math.PI / a), e.beginPath(), a)) {
                case 0:
                  e.arc(l, L, t, 0, 2 * Math.PI);
                  break;
                case 102:
                  for (let [a, r] of [
                    [1, 0],
                    ...
                    e.lineTo(
                      l + t * a * Math.cos(n - 0.025 + r),
                      L + t * a * Math.sin(n - 0.025 + r)
                    );
                  break;
                case 103:
                  for (let a = 0; 360 > a; a++) {
                    let r = 2 * (a / 360) * Math.PI,
                      o = l + t * Math.cos(r + n),
                      s = L + t * Math.sin(r + n);
                    135 == a
                      ? ((o = l), (s = L))
                      : 135 < a &&
                        ((o =
                          l + t * Math.cos(2 * ((a + 90) / 360) * Math.PI + n)),
                        (s =
                          L +
                          t * Math.sin(2 * ((a + 90) / 360) * Math.PI + n))),
                      e.lineTo(o, s);
                  }
                  break;
                case 104:
                  {
                    let a = 0.25;
                    e.moveTo(l + t * Math.cos(n), L + t * Math.sin(n));
                    for (let r = 0; 6 > r; r++) {
                      let o = 2 * ((r + 1) / 6) * Math.PI,
                        s = 2 * ((r + 0.5) / 6) * Math.PI,
                        i = {
                          x: l + t * a * Math.cos(s + n),
                          y: L + t * a * Math.sin(s + n)
                        },
                        d = {
                          x: l + t * Math.cos(o + n),
                          y: L + t * Math.sin(o + n)
                        };
                      e.quadraticCurveTo(i.x, i.y, d.x, d.y);
                    }
                  }
                  break;
                case 105:
                  for (let a = 0; 16 > a; a++) {
                    let r = 2 * (a / 16) * Math.PI,
                      o = l + t * Math.cos(r + n + 0.4),
                      s = L + t * Math.sin(r + n + 0.4);
                    (1 == a || 5 === a || 9 === a || 13 === a) &&
                      ((o = l), (s = L)),
                      e.lineTo(o, s);
                  }
                ...
                case 108:
                  for (let a = 0; 12 > a; a++) {
                    let r = 2 * (a / 12) * Math.PI,
                      o = l + t * Math.cos(r + (n - 0.025)),
                      s = L + t * Math.sin(r + (n - 0.025));
                    (2 == a || 10 === a || 6 === a) &&
                      ((o = l + (t / 2) * Math.cos(r + (n - 0.025))),
                      (s = L + (t / 2) * Math.sin(r + (n - 0.025)))),
                      (0 == a || 4 === a || 8 === a) &&
                        ((o = l + 1.25 * t * Math.cos(r + (n - 0.025))),
                        (s = L + 1.25 * t * Math.sin(r + (n - 0.025)))),
                      e.lineTo(o, s);
                  }
                  break;
                case 109:
                  for (let a = 0; 4 > a; a++) {
                    let r = 2 * (a / 3) * Math.PI,
                      ...
                      s = L + t * Math.sin(r + n);
                    2 == a
                      ? ((o = l + -0.25 * t * Math.cos(n)),
                        (s = L + -0.25 * t * Math.sin(n)))
                      : 2 < a &&
                        ((r = 2 * (a - 1 / 3) * Math.PI),
                        (o = l + t * Math.cos(r + n)),
                        (s = L + t * Math.sin(r + n))),
                ...
                case 111:
                  for (let a = 0; 4 > a; a++) {
                    let r = 2 * (a / 4) * Math.PI,
                      ...
                      s = L + t * Math.sin(r + n);
                    2 == a
                      ? ((o = l + -1.5 * t * Math.cos(n)),
                        (s = L + -1.5 * t * Math.sin(n)))
                      : (0 === a || 4 === a) &&
                        ((o = l + 1.5 * t * Math.cos(n)),
                        (s = L + 1.5 * t * Math.sin(n))),
                      e.lineTo(o, s);
                ...
                case 112:
                  for (let [a, r] of [
                    ...
                    e.lineTo(
                      l + t * a * Math.cos(n + (r - 0.025)),
                      L + t * a * Math.sin(n + (r - 0.025))
                    );
                  break;
                case 113:
                  for (let [a, r] of [
                ...
                case 116:
                  for (let [a, r] of [
                    ...
                    e.lineTo(
                      l + t * (1.5 * a) * Math.cos(n + (r - 0.0261)),
                      L + t * (1.5 * a) * Math.sin(n + (r - 0.0261))
                    );
                  break;
                case 117:
                  for (let [a, r] of [
                    ...
                    e.lineTo(
                      l + t * (0.9 * a) * Math.cos(n + r),
                      L + t * (0.9 * a) * Math.sin(n + r)
                    );
                  break;
                case 118:
                  for (let [a, r] of [
                    ...
                    e.lineTo(
                      l + t * a * Math.cos(n + (r - 0.0261)),
                      L + t * a * Math.sin(n + (r - 0.0261))
                    );
                  break;
                case 119:
                  for (let [a, r] of [
                ...
                case 122:
                  for (let [a, r] of [
                    ...
                    e.lineTo(
                      l + t * a * Math.cos(n + r + 1.5447),
                      L + t * a * Math.sin(n + r + 1.5447)
                    );
                  break;
                case 123:
                  for (let [a, r] of [
                  ...
                  break;
                case 124:
                  e.arc(l, L, t, 0, 2 * Math.PI, !0),
                    e.arc(l, L, t / 1.15, 0, 2 * Math.PI, !1);
                  break;
                case 125:
                  {
                    e.save(), e.translate(l, L), e.rotate(n);
                    let a = 0.4,
                      r = t * (1 - a),
                      o = t * a;
                    e.arc(r, r, o, 0, 0.5 * Math.PI),
                      e.arc(-r, r, o, 0.5 * Math.PI, Math.PI),
                      e.arc(-r, -r, o, Math.PI, 1.5 * Math.PI),
                      e.arc(r, -r, o, -0.5 * Math.PI, 0),
                      e.restore();
                  }
                  break;
                case 126:
                  {
                    let a = 0.4,
                      r = t * (1 - a),
                      o = t * a;
                    e.arc(l + r, L + r, o, n, 0.5 * Math.PI + n),
                      e.arc(l - r, L + r, o, 0.5 * Math.PI + n, Math.PI + n),
                      e.arc(l - r, L - r, o, Math.PI + n, 1.5 * Math.PI + n),
                      e.arc(l + r, L - r, o, -0.5 * Math.PI + n, n);
                  }
                  break;
                case 127:
                  {
                    ...
                    let a = 0.4,
                      r = t * (1 - a),
                      o = t * a;
                    e.arc(r, 0, o, -0.272 * Math.PI, 0.272 * Math.PI),
                      e.arc(-r, r, o, 0.272 * Math.PI, Math.PI),
                      e.arc(-r, -r, o, Math.PI, 1.544 * Math.PI),
                      e.restore();
                  }
                  break;
                case 128:
                  {
                    ...
                    for (let r = 0; r < a; r++) {
                      let o = 2 * (r / a) * Math.PI,
                        s = l + 1.5 * t * Math.cos(o + n + 45),
                        i = L + 1.5 * t * Math.sin(o + n + 45);
                      e.lineTo(s, i);
                    }
                  }
                  break;
                case 129:
                  {
                    ...
                    (a = -a),
                      e.moveTo(l + t * Math.cos(n), L + t * Math.sin(n));
                    for (let o = 0; o < a; o++) {
                      let s = 2 * ((o + 1) / a) * Math.PI,
                        i = 2 * ((o + 0.5) / a) * Math.PI,
                        d = {
                          x: l + t * r * Math.cos(i + n),
                          y: L + t * r * Math.sin(i + n)
                        },
                        c = {
                          x: l + t * Math.cos(s + n),
                          y: L + t * Math.sin(s + n)
                        };
                      e.quadraticCurveTo(d.x, d.y, c.x, c.y);
                    }
                  }
                  break;
                case 130:
                ...
                case 131:
                  e.arc(l, L, t, 0, 2 * Math.PI, !0),
                    e.arc(l, L, t / 1.05, 0, 2 * Math.PI, !1);
                  break;
                case 132:
                  e.arc(l, L, t, 0, 2 * Math.PI, !0),
                    e.arc(l, L, t / 1.5, 0, 2 * Math.PI, !1);
                  break;
                case 133:
                  for (let a = 0; 11 > a; a++) {
                    let r = 2 * (a / 11) * Math.PI,
                      o = l + 1.5 * t * Math.cos(180 / 11 + r + n + 1.635),
                      s = L + 1.5 * t * Math.sin(180 / 11 + r + n + 1.635);
                    e.lineTo(o, s);
                  }
                  break;
                case 134:
                  {
                    ...
                    for (let r = 0; r < a; r++) {
                      let o = 2 * (r / a) * Math.PI,
                        s = l + 1.5 * t * Math.cos(45 + o + n + 0.52),
                        i = L + 1.5 * t * Math.sin(45 + o + n + 0.52);
                      e.lineTo(s, i);
                    }
                  }
                  break;
                case 135:
                  for (let a = 0; 6 > a; a++) {
                    let r = 2 * (a / 6) * Math.PI,
                      o = l + 1.1 * t * Math.cos(30 + r + n + 0.385),
                      s = L + 1.1 * t * Math.sin(30 + r + n + 0.385);
                    e.lineTo(o, s);
                  }
                  break;
                case 136:
                  e.arc(l, L, t, 0, 2 * Math.PI, !0),
                    e.arc(l, L, 0.999999 * t, 0, 2 * Math.PI, !1);
                  break;
                case 137:
                  for (let [a, r] of [
                    [1, 0],
                ...
                case 141:
                  for (let a = 0; 4 > a; a++) {
                    let r = 2 * (a / 4) * Math.PI,
                      ...
                      s = L + t * Math.sin(r + n);
                    0 == a &&
                      ((o = l + 1.7 * t * Math.cos(n)),
                      (s = L + 1.7 * t * Math.sin(n))),
                      e.lineTo(o, s);
                  }
                  break;
                case 142:
                  for (let [a, r] of [
                    ...
                    e.lineTo(
                      l + t * a * Math.cos((r * Math.PI) / 180 + n),
                      L + t * a * Math.sin((r * Math.PI) / 180 + n)
                    );
                  break;
                case 143:
                  for (let [a, r] of [
                  ...
                  for (let a = 0; 360 > a; a++) {
                    ...
                    180 == a
                      ...
                      : 180 < a &&
                        ((o =
                          l +
                          t * Math.cos(2 * ((a + 180) / 360) * Math.PI + n)),
                        (s =
                          L +
                          t * Math.sin(2 * ((a + 180) / 360) * Math.PI + n))),
                      e.lineTo(o, s);
                  }
                  break;
                case 146:
                  e.arc(l, L, t, 0, 2 * Math.PI, !0),
                    e.arc(l, L, 1.1 * t, 0, 2 * Math.PI, !1);
                  break;
                case 147:
                  for (let [a, r] of [[8, 0], [1, 120], [1, 240]])
                    e.lineTo(
                      l + t * a * Math.cos((r * Math.PI) / 180 + n),
                      L + t * a * Math.sin((r * Math.PI) / 180 + n)
                    );
                ...
                case 148:
                  ...
                  break;
                case 149:
                  e.arc(l, L, t, n + Math.PI / 2, (3 * Math.PI) / 2 + n);
                  break;
                case 150:
                  for (let [a, r] of [
                    [1, 0],
                ...
                case 157:
                  e.arc(l, L, t, 0, 2 * Math.PI, !0),
                    e.arc(l, L, 0.475 * t, 0, 2 * Math.PI, !1);
                  break;
                case 158:
                  for (let [a, r] of [
                    [-1.1, 0],
                  ...
                  break;
                case 998:
                  e.arc(l, L, t, 0, Math.PI, !1);
                  break;
                case 999:
                  e.arc(l, L, t, 0, Math.PI, !0);
                  break;
                default:
                  if (0 > a) {
                    let r = 1 - 6 / a / a;
              ...
              if (158 < a && 190 > a) {
                ...
                switch (a) {
                  ...
                  case 209:
                    (o = new Path2D(
                      "m-3.1884842 -.007504462l0.84110737 -.46545094l-0.59896183 -.75189334l0.9552134 -.10814953l-0.26564586 -.92389536l0.92389536 .26564574l0.10814953 -.9552133l0.7518934 .5989616l0.46545094 -.84110713l0.46545094 .84110713l0.7518933 -.5989616l0.10814953 .9552133l0.9238956 -.26564574l-0.26564598 .92389536l0.95521355 .10814953l-0.59896183 .75189334l0.84110713 .46545094l-0.84110713 .46545094l0.59896183 .75189334l-0.95521355 .10814953l0.26564598 .9238956l-0.9238956 -.26564598l-0.10814953 .9552133l-0.7518933 -.5989616l-0.46545094 .84110713l-0.46545094 -.84110713l-0.7518934 .5989616l-0.10814953 -.9552133l-0.92389536 .26564598l0.26564586 -.9238956l-0.9552134 -.10814953l0.59896183 -.75189334z"
                    )),
                      (s = 2.2);
                    break;
                  case 210:
                    (o = new Path2D(
                      "m-222.6584 -119.30652c15.722656 -69.82634 66.359146 -74.449265 94.33595 -94.33333c27.976814 -19.884079 46.35739 -29.132996 73.52493 -24.97113c27.167542 4.16185 49.711285 38.38188 89.480316 49.942245c39.769024 11.560379 121.15704 -43.932632 149.13387 19.419952c27.976807 63.352585 86.472885 298.2677 18.727036 360.69556c-67.74585 62.427826 -354.33508 65.66359 -425.2021 13.871384c-70.86702 -51.792206 -15.722656 -254.79834 0 -324.62466z"
                    )),
                      (s = 90);
                    break;
                  case 211:
                    o = new Path2D(
                      "M 1.1926452,8.2525e-4 .57453922,0.95420971 .04413176,0.78344108 -1.2866688,0.94915731 -.64483857,0.28750215 v -.57500783 l -.64183023,-0.66165511 1.33080056,0.16571618 .53040746,-0.1707686 z"
                    );
                    break;
                  case 212:
                    (o = new Path2D(
                      "m0 -210l0.0866127 -4.3359575l1.2152252 -1.2152233l1.9921265 -.08661413l1.3018341 1.0419946l1.1259842 2.1679792l1.1286125 2.6010494l9.2782135 0l1.2125969 1.994751l30.519684 0l0.9553833 -1.6482935l0.8661423 -.34645748l1.3884506 0l0.77952576 .8661423l5.2021027 9.538057l80.72178 0l1.6483002 2.0813656l26.356949 0l23.498688 0l1.994751 -1.994751l114.88452 0l0 -8.149607l3.6404114 0l0 2.0813646l9.451447 0l0 -1.99475l4.6824036 0l3.8136597 7.110235l8.32547 5.635172l0.25982666 5.808399l1.8189087 0l0 1.6482925l2.0813599 0l0 2.2545948l-2.2545776 0l0 10.577427l1.6036682 .43044662l0 4.4251976l-2.2966003 0l0 6.2414703l-2.2545776 14.3937l-2.427826 9.884514l-3.9868774 8.409447l-28.614166 0l-6.590576 7.6325455l-1.8188782 2.1653595l-19.509186 0l-2.3385925 -2.338585l-48.38321 0l-3.8162537 3.2073517
                      "m 4.7e-6,-0.77690113 a .19543078,0.19543078 0 0 0 -.1954333,0.19542001 .19543078,0.19543078 0 0 0 .018262,0.082 H -.5 v .34378 a .19543078,0.19543078 0 0 1 .1170201,-0.0392 A .19543078,0.19543078 0 0 1 -.1875466,5.3887506e-4 .19543078,0.19543078 0 0 1 -.3829799,0.19596888 .19543078,0.19543078 0 0 1 -.5,0.15676886 v .3437201 h .3228437 a .19543078,0.19543078 0 0 0 -.018272,0.082 .19543078,0.19543078 0 0 0 .1954333,0.19544 .19543078,0.19543078 0 0 0 .1954235,-0.19544 .19543078,0.19543078 0 0 0 -.018263,-0.082 h .3228339 v -.3437701 a .19543078,0.19543078 0 0 1 -.1170102,0.0392 A .19543078,0.19543078 0 0 1 .1875559,4.8885506e-4 .19543078,0.19543078 0 0 1 .3829892,-0.19495114 a .19543078,0.19543078 0 0 1 .1170102,0.0392 v -.34376 H .1771559 a .19543078,0.19543078 0 0 0 .018272,-0.082 A .19543078,0.19543078 0 0 0 4.4e-6,-0.77693113 Z"
                    )),
                      (s = 1 / 2);
                    break;
                  case 243:
                  ...
                  case 273:
                    (o = new Path2D(
                      "m-55.724384 -41.661858l110.86614 0l0 83.055115l-110.86614 0z"
                    )),
                      (s = 70);
                    break;
                  case 274:
                    (o = new Path2D(
                      "m-56.0803 -.3169869l56.04987 -56.04987l28.249344 28.249344l0 55.958008l-28.160105 28.160105z"
                    )),
                      (s = 30);
                    break;
                  case 275:
                  ...
                  case 279:
                    (o = new Path2D(
                      "M 36095.94156434246 -18178.901427781693 C 36096.766822630176 1901.2925509294437 19819.88215293352 18180.523791155094 -260.311736101954 18182.593201963173 -20340.50562513742 18184.66261277126 -36620.74533667949 1908.7866222731082 -36624.058899999996 -18171.4071 L -264.05890000000363 -18177.4071 Z"
                    )),
                      (s = 2e4);
                    break;
                  case 280:
                    (o = new Path2D(
                      "M 994.5926706014361 -56724.497201560764 C 33330.16971105673 -56564.93472966795 59437.46449163744 -30266.370352159516 59360.990692470434 2069.50994325996 59284.51689330343 34405.390238679436 33053.123548205214 60580.17452151223 717.1535000000149 60586.7899 L 705.1535000000003 1930.7899000000034 Z"
                    )),
                      (s = 22e3);
                    break;
                  case 281:
                    (o = new Path2D(
                      "M -110592.5825 -166982.721 L -110592.5825 170413.26870000004 114825.12539999998 170413.26870000004 114825.12539999998 105173.64010000005 -34641.90770000001 105173.64010000005 -34641.90770000001 -166982.721 Z"
                    )),
                      (s = 22e4);
                    break;
                  case 282:
                  ...
                  case 283:
                    (o = new Path2D(
                      "M -110592.5825 -166982.721 L -110592.5825 -102229.95529999999 -8838.15280000001 -102229.95529999999 -8838.15280000001 170413.26870000004 67112.52199999998 170413.26870000004 67112.52199999998 -102229.95529999999 168866.95169999998 -102229.95529999999 168866.95169999998 -166982.721 Z"
                    )),
                      (s = 22e4);
                    break;
                  case 284:
                ...
                try {
                  ...
                  logger.error(
                    "It appears the following shape is broken: " + a + "."
                  ),
                    logger.error(l);
                }
                r && e.fill(o), e.restore();
              }
              e.closePath(), e.stroke(), r && e.fill(), (e.lineJoin = "round");
            },
            l = (e, L, t, a, n, s, i, d) => {
              let c = [];
              c = 0 < s ? [n * s, n] : [n, -n * s];
              let m = [Math.atan2(c[0], a), Math.atan2(c[1], a)],
                r = [
                  Math.sqrt(a * a + c[0] * c[0]),
                  Math.sqrt(a * a + c[1] * c[1])
                ];
              switch ((e.beginPath(), d)) {
                case 0:
                  e.lineTo(
                    L + r[0] * Math.cos(i + m[0]),
                    t + r[0] * Math.sin(i + m[0])
                  ),
                    e.lineTo(
                      L + r[1] * Math.cos(i + Math.PI - m[1]),
                      t + r[1] * Math.sin(i + Math.PI - m[1])
                    ),
                    e.lineTo(
                      L + r[1] * Math.cos(i + Math.PI + m[1]),
                      t + r[1] * Math.sin(i + Math.PI + m[1])
                ...
                case 1:
                  e.lineTo(
                    L + r[1] * Math.cos(i - m[0] / 3),
                    t + r[1] * Math.sin(i - m[0] / 3)
                  ),
                    e.lineTo(
                      L + 1.25 * (r[1] * Math.cos(i)),
                      t + 1.25 * (r[1] * Math.sin(i))
                    ),
                    e.lineTo(
                      L + r[1] * Math.cos(i + m[0] / 3),
                      t + r[1] * Math.sin(i + m[0] / 3)
                ...
                case 2:
                  e.lineTo(
                    ...
                    e.bezierCurveTo(
                      L + 0.25 * (r[0] * Math.cos(i - m[0])),
                      t + 0.25 * (r[0] * Math.sin(i - m[0])),
                      L + 0.25 * (r[0] * Math.cos(i + m[0])),
                      t + 0.25 * (r[0] * Math.sin(i + m[0])),
                      L + r[0] * Math.cos(i + m[0]),
                      t + r[0] * Math.sin(i + m[0])
                ...
                case 7:
                  e.lineTo(
                    ...
                    e.lineTo(
                      L + r[1] * Math.cos(i + Math.PI + 4.25 * m[1]),
                      t + r[1] * Math.sin(i + Math.PI + 4.25 * m[1])
                    ),
                    e.lineTo(
                      L + r[0] * Math.cos(i - m[0]),
                      t + r[0] * Math.sin(i - m[0])
                ...
                case 9:
                  e.lineTo(
                    ...
                    e.lineTo(
                      L + 2 * r[0] * Math.cos(i - 0.5 * m[0]),
                      t + 2 * r[0] * Math.sin(i - 0.5 * m[0])
                    );
                  break;
                case 10:
                  e.lineTo(
                ...
                case 11:
                  e.lineTo(
                    ...
                    e.lineTo(L + r[0] * Math.cos(i), t + r[0] * Math.sin(i)),
                    e.lineTo(
                      L + r[1] * Math.cos(i + Math.PI),
                      t + r[1] * Math.sin(i + Math.PI)
                    ),
                    e.lineTo(L + r[0] * Math.cos(i), t + r[0] * Math.sin(i));
                  break;
                case 12:
                  e.lineTo(
                    ...
                    e.bezierCurveTo(
                      L + 0.5 * (r[0] * Math.cos(i - m[0])),
                      t + 0.5 * (r[0] * Math.sin(i - m[0])),
                      L + 0.5 * (r[0] * Math.cos(i + m[0])),
                      t + 0.5 * (r[0] * Math.sin(i + m[0])),
                      L + r[0] * Math.cos(i + m[0]),
                      t + r[0] * Math.sin(i + m[0])
                ...
                case 13:
                  e.lineTo(
                    ...
                    e.lineTo(L + r[1] * -Math.cos(i), t + r[1] * -Math.sin(i)),
                    e.lineTo(
                      L + r[0] * Math.cos(i - m[0]),
                      t + r[0] * Math.sin(i - m[0])
                    );
                ...
                case 16:
                  e.lineTo(
                    L + 0.5 * (r[0] * Math.cos(i)),
                    t + 0.5 * (r[0] * Math.sin(i))
                  ),
                    e.lineTo(
                      L + r[0] * Math.cos(i + m[0]),
                      t + r[0] * Math.sin(i + m[0])
              ...
              (e.lineJoin = o.pointy ? "miter" : "round"),
                e.closePath(),
                e.stroke(),
                e.fill();
            };
          return (L, n, r, c, h, g, u, y, v, b, E) => {
            g === void 0 && (g = 1),
              u === void 0 && (u = 0),
              y === void 0 && (y = 0),
              v === void 0 && (v = 0),
              ...
              E === void 0 && (E = r.render);
            let x = v || a,
              S = b ? 1 : E.status.getFade(),
              I = (b ? 1 : E.status.getFade()) * h,
              T = g * c * r.size,
              z = F[r.index],
              m = L,
              P = n,
              M = 0 === b ? r : b;
            T *= 1 + (E.expandsWithDeath ? 0.5 : 0.2) * (1 - S);
            try {
              if (
                ((t.loadingMockups = !1),
                "low" !== o.quality && v !== i && 1 > I && 0 < I)
              )
                (x = i),
                  (x.canvas.width = x.canvas.height =
                    T * z.position.axis + 7.5 * c * r.size),
                  (m =
                    x.canvas.width / 2 -
                    (T * z.position.axis * z.position.middle.x * Math.cos(u)) /
                      4),
                  (P =
                    x.canvas.height / 2 -
                    (T * z.position.axis * z.position.middle.x * Math.sin(u)) /
                      4);
              else if (0.1 >= S * I) return;
              if (
                ((x.lineCap = o.pointy ? "miter" : "round"),
                (x.lineJoin = o.pointy ? "miter" : "round"),
                M.turrets.length === z.turrets.length)
              ) {
                for (let e = 0, l; e < z.turrets.length; e++)
                  if (((l = z.turrets[e]), 0 === l.layer)) {
                    let L = l.direction + l.angle + u,
                      a = l.offset * T,
                      n = M.turrets[e],
                      r = n.facing;
                    if (0 < n.turretId) {
                      let e = t.turretAngles[0].indexOf(n.turretId);
                      -1 === e
                        ? (t.turretAngles[0].push(n.turretId),
                          t.turretAngles[1].push(r))
                        : ((r = X(t.turretAngles[1][e], r, 0.1)),
                          (t.turretAngles[1][e] = r));
                    }
                    be(
                      m + a * Math.cos(L),
                      P + a * Math.sin(L),
                ...
                100 < t.turretAngles[0].length &&
                  (t.turretAngles[0].splice(0, z.turrets.length),
                  t.turretAngles[1].splice(0, z.turrets.length));
              } else throw new Error("Mismatch turret number with mockup!");
              M.guns.update();
              let h = E.status.getColor(),
                F = E.status.getBlend(),
                b = d(p(r.color), h, F),
                C = r.invuln && 100 < (Date.now() - r.invuln) % 200;
              if (
                (C && (b = d(b, s.vlgrey, 0.5)),
                (x.lineWidth = Math.max(
                  o.mininumBorderChunk,
                  c * o.borderChunk
                )),
                M.guns.length === z.guns.length)
              ) {
                let e = M.guns.getPositions();
                for (let L = 0; L < z.guns.length; L++) {
                  let t = z.guns[L],
                    a = e[L] / (1 === t.aspect ? 2 : 1),
                    n =
                      t.offset * Math.cos(t.direction + t.angle + u) +
                      (t.length / 2 - a) * Math.cos(t.angle + u),
                    r =
                      t.offset * Math.sin(t.direction + t.angle + u) +
                      (t.length / 2 - a) * Math.sin(t.angle + u),
                    o = d(p(t.color), h, F);
                  switch ((C && (o = d(o, s.vlgrey, 0.5)), t.color_unmix)) {
                    case 0:
                      k(x, o);
                      break;
                    case 1:
              ...
              if (
                ((x.globalAlpha = 1),
                k(x, b),
                e(x, m, P, (T / z.size) * z.realSize, z.shape, u),
                M.turrets.length === z.turrets.length)
              ) {
                for (let e = 0, l; e < z.turrets.length; e++)
                  if (((l = z.turrets[e]), 1 === l.layer)) {
                    let L = l.direction + l.angle + u,
                      a = l.offset * T,
                      n = M.turrets[e],
                      r = n.facing;
        ...
        Ee = (e, l, L, r, i) => {
          let d = L.render.status.getFade(),
            c = i;
          "low" === o.quality && (c = 0.1 > c ? 0 : 0.1 <= c ? 1 : i),
            (a.globalAlpha = d * d);
          let h = L.size * r,
            g = F[L.index],
            m = (h / g.size) * g.realSize;
          if (L.drawsHealth) {
            let t = L.render.health.get(),
              n = L.render.shield.get();
            if (0.999 > t || 0.999 > n) {
              let L = l + 1.1 * m + 15,
                r = c * c * d;
              (a.globalAlpha = r),
                Le(e - h, e + h, L, 5 + o.barChunk, s.black),
                n &&
                  ((a.globalAlpha = (0.3 + 0.3 * n) * r),
                  Le(e - h, e - h + 2 * h * n, L, 9, s.teal),
                  (a.globalAlpha = r)),
                Le(e - h, e - h + 2 * h * t, L, 3, s.lgreen);
            }
          }
          if (L.id === _.playerid) t.player.nameColor = L.nameColor;
          else if (L.nameplate) {
            null == L.render.textobjs && (L.render.textobjs = [V(), V()]);
            let t = L.nameColor,
              o = (r * (45 < L.size ? 45 : L.size)) / 20,
              i = 16 * o,
              d = l - m - 30 * o;
            (a.globalAlpha = c),
              L.name.includes("U\u2000S\u2000A")
                ? (L.render.textobjs[0].draw(
                    "U",
                    e - 14 * o,
                    d,
                    i,
                  ...
                  L.render.textobjs[0].draw("S", e, d, i, s.guiwhite, "center"),
                  L.render.textobjs[0].draw(
                    "A",
                    e + 14 * o,
                    d,
                ...
                : L.render.textobjs[0].draw(L.name, e, d, i, t, "center"),
              L.render.textobjs[1].draw(
                n.handleLargeNumber(L.score, !0),
                e,
                l - m - i,
                8 * o,
                t,
      ...
      let xe = (() => {
          let e = E(0, 0.025),
            ...
            L = () => {
              let e = [];
              return (l, L, t, n, r, o) => {
                for (e.push(l); e.length > n; ) e.splice(0, 1);
                let d = Math.min.apply(Math, e),
                  c = Math.max.apply(Math, e),
                  h = c - d;
                0 < c && 0 > d && Le(L, L + n, t + (r * c) / h, 2, s.guiwhite),
                  a.beginPath();
                let m = -1;
                for (let s = 0, i; s < e.length; s++)
                  (i = e[s]),
                    ++m
                      ? a.lineTo(L + m, t + (r * (c - i)) / h)
                      : a.moveTo(L, t + (r * (c - i)) / h);
                (a.lineWidth = 1), (a.strokeStyle = o), a.stroke();
              };
            },
            r = (() => {
              let e = (e, l) => {
                ...
                l = (l, L) => {
                  null == l && (l = !1), null == L && (L = P.rendergap);
                  let t = !1 === l ? O() - P.lastuplink : Y() - l;
                  L = Math.max(L, 1e3 / o.roomSpeed / 30);
                  let a = t / L;
                  return {
                    predictExtrapolate: (e, l) => e + (l - e) * a,
                    predictFacingExtrapolate: (l, L) => l + e(L, l) * a,
                    getPrediction: () => a
                  };
                };
              return (e, L) => l(e, L);
            ...
            c = (() => {
              let e = e => Math.log(4 * e + 1) / Math.log(5),
                l = [];
              for (let L = 0; L < 18; L++) l.push(e(L / 9));
              return e => l[e];
            })(),
            m = L(),
            g = L(),
            u = L(),
            f = {
              skillNames: [V(), V(), V(), V(), V(), V(), V(), V(), V(), V()],
              skillKeys: [V(), V(), V(), V(), V(), V(), V(), V(), V(), V()],
              skillValues: [V(), V(), V(), V(), V(), V(), V(), V(), V(), V()],
              skillPoints: V(),
              score: V(),
              name: V(),
              class: V(),
              debug: [V(), V(), V(), V(), V(), V(), V()],
              lbtitle: V(),
              leaderboard: [V(), V(), V(), V(), V(), V(), V(), V(), V(), V()],
              upgradeNames: [
                V(),
                V(),
                V(),
          ...
          return L => {
            ...
            let E, z;
            {
              let e = r();
              k = e.getPrediction();
              let l = q(t.player.renderx, t.player.x, 0.1),
                a = q(t.player.rendery, t.player.y, 0.1);
              (t.player.renderx = l),
                (t.player.rendery = a),
                (E = L * t.player.renderx),
                (z = L * t.player.rendery);
            }
            {
              N(s.white, 1),
                N(s.guiblack, 0.1),
                t.radial
                  ? (a.save(),
                    a.translate(t.screenWidth / 2, t.screenHeight / 2),
                    a.rotate(t.player.offset),
                    a.translate(t.screenWidth / -2, t.screenHeight / -2),
                    (a.globalAlpha = 1),
                    (a.fillStyle = s.white),
                    a.beginPath(),
              ...
              if (!t.radial)
                for (let l = 0; l < D.length; l++) {
                  ...
                  for (let c = 0; c < i.length; c++) {
                    let l = Math.max(
                        0,
                        (L * d * t.gameWidth) / e - E + t.screenWidth / 2
                      ),
                      h = Math.max(
                        0,
                        (L * r * t.gameHeight) / n - z + t.screenHeight / 2
                      ),
                      m = Math.min(
                        t.screenWidth,
                        (L * (d + 1) * t.gameWidth) / e - E + t.screenWidth / 2
                      ),
                      g = Math.min(
                        t.screenHeight,
                        (L * (r + 1) * t.gameHeight) / n -
                          z +
                          t.screenHeight / 2
                      );
                    (a.globalAlpha = 1),
                      (a.fillStyle = o.screenshotMode ? s.guiwhite : s.white),
                      a.fillRect(l, h, m - l, g - h),
                      (a.globalAlpha = 0.3),
                      (a.fillStyle = o.screenshotMode
                        ? s.guiwhite
                        : v(i[c], 1)),
                      a.fillRect(l, h, m - l, g - h),
                      d++;
              ...
              (a.lineWidth = 1),
                (a.strokeStyle = o.screenshotMode ? s.guiwhite : s.guiblack),
                (a.globalAlpha = 0.04),
                a.beginPath();
              let l = 30 * L;
              if (t.radial) {
                let e =
                  ...
                  Math.ceil(
                    Math.sqrt(
                      t.screenWidth * t.screenWidth +
                        t.screenHeight * t.screenHeight
                    ) /
                      L /
                      L /
                      60
                  ...
                  L;
                for (
                  let L = ((t.screenWidth / 2 - E) % l) - e;
                  L < t.screenWidth + e;
                  L += l
                )
                  a.moveTo(L, -e), a.lineTo(L, e + t.screenHeight);
                for (
                  let L = ((t.screenHeight / 2 - z) % l) - e;
                  L < t.screenHeight + e;
                  L += l
                )
                  a.moveTo(-e, L), a.lineTo(e + t.screenWidth, L);
              } else {
                for (
                  let e = (t.screenWidth / 2 - E) % l;
                  e < t.screenWidth;
                  e += l
                )
                  a.moveTo(e, 0), a.lineTo(e, t.screenHeight);
                for (
                  let e = (t.screenHeight / 2 - z) % l;
                  e < t.screenHeight;
                  e += l
                )
                  a.moveTo(0, e), a.lineTo(t.screenWidth, e);
              }
              a.stroke(), (a.globalAlpha = 1), t.radial && a.restore();
            }
            {
              if (t.loadingMockups) {
                let e = V();
                e.draw(
                  "Loading entity mockups...",
                  t.screenWidth / 2,
                  t.screenHeight / 2,
                  30,
                  s.lgreen,
              ...
              if (t.radial) {
                ...
                let L = X(
                  t.player.offset,
                  Math.atan2(
                    t.gameWidth / 2 - t.player.x,
                    t.gameHeight / 2 - t.player.y
                  ),
                  0.025
                );
                (e = Math.sin(L)),
              ...
              x.forEach(a => {
                if (!a.render.draws) return 1;
                let n = a.id === _.playerid;
                if (!n && 0 >= a.alpha) return 1;
                if (1 === a.render.status.getFade())
                  (a.render.x = q(a.render.x, a.x + a.vx, 0.1)),
                    (a.render.y = q(a.render.y, a.y + a.vy, 0.1)),
                    (a.render.f =
                      !n || a.twiggle || t.died
                        ? X(a.render.f, a.facing, 0.25)
                        : Math.atan2(t.target.y, t.target.x));
                else if ("low" !== o.quality) {
                  let e = r(a.render.lastRender, a.interval);
                  (a.render.x = e.predictExtrapolate(a.render.lastx, a.x)),
                    (a.render.y = e.predictExtrapolate(a.render.lasty, a.y)),
                    (a.render.f =
                      !n || a.twiggle || t.died
                        ? e.predictFacingExtrapolate(a.render.lastf, a.facing)
                        : Math.atan2(t.target.y, t.target.x));
                }
                let s = L * a.render.x - E,
                  i = L * a.render.y - z;
                if (t.radial) {
                  let L = l * i + e * s;
                  (s = l * s - e * i + t.screenWidth / 2),
                    (i = L + t.screenHeight / 2);
                } else (s += t.screenWidth / 2), (i += t.screenHeight / 2);
                n &&
                  ((t.player.canSeeInvisible = a.seeInvisible),
                  (t.player.cx = s),
                  (t.player.cy = i)),
                  be(
                    s,
                    ...
                    a,
                    L,
                    !n && t.player.canSeeInvisible && 0.35 > a.alpha
                      ? 0.35
                      : a.alpha,
                    1.1,
                    a.render.f
                ...
                o.screenshotMode ||
                  x.forEach(a => {
                    ...
                    let n = L * a.render.x - E,
                      r = L * a.render.y - z;
                    if (t.radial) {
                      let L = l * r + e * n;
                      (n = l * n - e * r + t.screenWidth / 2),
                        (r = L + t.screenHeight / 2);
                    } else (n += t.screenWidth / 2), (r += t.screenHeight / 2);
                    Ee(
                      n,
                      r,
                      a,
            ...
            do {
              if (!t.showTree) break;
              t.died && ((t.showTree = !1), (t.scrollX = 0));
              let e = F.find(e => e.name === t.searchName);
              if (!e) break;
              a.globalAlpha = 1;
              let l = [],
                L = [],
                n = (e, t, a, { index: r, tier: o = 0 }) => {
                  l.push({ x: e, y: t, colorIndex: a, index: r });
                  let { upgrades: s } = F[r];
                  switch (o) {
                    case 4:
                    ...
                    case 3:
                      return (
                        s.forEach((l, L) => n(e, t + 2 + L, L, l)),
                        L.push([{ x: e, y: t }, { x: e, y: t + 1 + s.length }]),
                      ...
                      let l = e,
                        a = s.map((a, r) => {
                          ...
                          return (
                            ...
                            r + 1 === s.length &&
                              L.push([{ x: l, y: t + 1 }, { x: e, y: t + 1 }]),
                            (e += d.width),
                            d
                          );
                        });
                      return {
                        width: a.map(e => e.width).reduce((e, l) => e + l, 0),
                        height: 2 + Math.max(...a.map(e => e.height))
                      };
                    }
                  }
                },
                r = n(0, 0, 0, { index: e.index }),
                o = "Basic" === t.searchName ? 0.8 : 1.25,
                i =
                  Math.min(
                    55 * ((0.9 * t.screenWidth) / r.width),
                    (0.9 * t.screenHeight) / r.height
                  ) / o,
                d = i - 4;
              for (let [e, l] of L) {
                let L =
                    t.screenWidth / 2 +
                    (e.x - r.width * t.scrollX) * i +
                    1 +
                    0.5 * d,
                  n =
                    t.screenHeight / 2 + (e.y - r.height / 2) * i + 1 + 0.5 * d,
                  o =
                    t.screenWidth / 2 +
                    (l.x - r.width * t.scrollX) * i +
                    1 +
                    0.5 * d,
                  c =
                    t.screenHeight / 2 + (l.y - r.height / 2) * i + 1 + 0.5 * d;
                (a.strokeStyle = s.black),
                  (a.lineWidth = 2),
                  le(L, n + 60, o, c + 60);
              }
              for (let { x: e, y: L, colorIndex: n, index: o } of l) {
                let l = t.screenWidth / 2 + (e - r.width * t.scrollX) * i,
                  d = t.screenHeight / 2 + (L - r.height / 2) * i + 60,
                  c = i;
                if (
                  ((n = t.tankMenuColor), -30 > l || l + c - 30 > t.screenWidth)
                )
                  continue;
                (a.globalAlpha = 0.75),
                  (a.fillStyle = p(185 < n ? n - 85 : n)),
                  J(l, d, c, c),
                  (a.globalAlpha = 0.15),
                  (a.fillStyle = p(-10 + (n++ - (185 < n ? 85 : 0)))),
                  J(l, d, c, 0.6 * c),
                  (a.fillStyle = s.black),
                  J(l, d + 0.6 * c, c, 0.4 * c),
                  (a.globalAlpha = 1);
                let h = -Math.PI / 4,
                  ...
                  g = F[o].position,
                  u = (0.8 * c) / g.axis,
                  y = l + 0.5 * c - u * g.middle.x * Math.cos(h),
                  v = d + 0.5 * c - u * g.middle.x * Math.sin(h);
                be(y, v, m, 0.5, 1, 2 * (u / m.size), h, 1),
                  (a.strokeStyle = s.black),
                  (a.globalAlpha = 1),
                  (a.lineWidth = 2),
                  J(l, d, c, c, 1);
            ...
            let M =
              200 /
              Math.max(
                t.screenWidth / t.pixelRatio,
                (16 * (t.screenHeight / t.pixelRatio)) / 9
              );
            "high" === o.quality &&
              (a.scale(window.devicePixelRatio, window.devicePixelRatio),
              (t.screenWidth /= window.devicePixelRatio),
              (t.screenHeight /= window.devicePixelRatio)),
              _.skill.update();
            let A = R.get(),
              w = A.max;
            if (!o.disableMessages) {
              let e = t.screenWidth / 2,
                l = 20,
                L;
              for (let t = T.length - 1; 0 <= t; t--) {
                let n = T[t],
                  ...
                  o = r;
                if (
                  (null == n.textobj && (n.textobj = V()),
                  null == n.len && (n.len = j(o, 14)),
                  (a.globalAlpha = 0.5 * n.alpha),
                  (L =
                    "rainbow" === n.color
                      ? h(`hsl(${(Date.now() % 2520) / 7}, 100%, 50%)`)
                      : n.color),
                  Le(e - n.len / 2, e + n.len / 2, l + 9, 18, L),
                  (a.globalAlpha = Math.min(1, n.alpha)),
                  n.textobj.draw(o, e, l + 9, 14, s.guiwhite, "center", !0),
                  (l += 22),
                  1 < n.status && (l -= 22 * (1 - Math.sqrt(n.alpha))),
                  1 < n.status)
                )
                  (n.status -= 0.05), (n.alpha += 0.05);
                else if (
                  0 === t &&
                  (8 < T.length || 7500 < Date.now() - n.time)
                ) {
                  let e = 0.05 * (T.length - 8);
                  0 >= e && (e = 0.05),
                    (n.status -= e),
                    (n.alpha -= e),
                    0 >= n.alpha && (T[0].textobj.remove(), T.splice(0, 1));
                }
              }
              a.globalAlpha = 1;
            }
            {
              (t.canSkill = !!_.points),
                e.set(0 + (t.canSkill || t.died || t.statHover)),
                t.clickables.stat.hide();
              let l = 15,
                L = 35,
                n = M * t.screenWidth,
                r = n,
                d = -20 - 2 * n + e.get() * (40 + 2 * n),
                h = t.screenHeight - 20 - 15,
                i = 11,
                m = _.getStatNames(F[_.type].statnames || -1);
              _.skills.forEach(e => {
                i--;
                let g = m[i - 1],
                  p = e.amount,
                ...
                if (y) {
                  ...
                  if (
                    ...
                    (a.lineWidth = 1), (a.strokeStyle = s.grey);
                    for (let t = y + 1; t < e; t++)
                      le(
                        d + (n - L) * c(t),
                        h + 1.5,
                  ...
                  (a.strokeStyle = s.black), (a.lineWidth = 1);
                  for (let e = 1; e < p + 1; e++)
                    le(
                      d + (n - L) * c(e),
                      h + 1.5,
                  ...
                  let k =
                    p == v
                      ...
                      ? s.guiwhite
                      : s.grey;
                  f.skillNames[i - 1].draw(
                    g,
                    Math.round(d + n / 2) + 0.5,
                    h + l / 2,
                    10,
                    k,
                    "center",
                    ...
                    f.skillKeys[i - 1].draw(
                      "[" + (i % 10) + "]",
                      Math.round(d + n - 0.25 * l) - 1.5,
                      h + l / 2,
                      10,
                      k,
                      "right",
                    ...
                    k === s.guiwhite &&
                      t.clickables.stat.place(i - 1, d, h, n, l),
                    p &&
                      f.skillValues[i - 1].draw(
                        k === u ? "MAX" : "+" + p,
                        Math.round(d + n + 4) + 0.5,
                        h + l / 2,
                        10,
                        u,
                        "left",
                ...
                t.clickables.hover.place(
                  0,
                  0,
                  h,
                  0.8 * n,
                  0.8 * (t.screenHeight - h)
                ),
                0 !== _.points &&
                  f.skillPoints.draw(
                    "x" + _.points,
                    Math.round(d + n - 2) + 0.5,
                    Math.round(h + 15 - 4) + 0.5,
                    20,
                    s.guiwhite,
                    "right"
                  );
            ...
            {
              let e = 1.65 * M * t.screenWidth,
                l = 25,
                L = (t.screenWidth - e) / 2,
                r = t.screenHeight - 20 - l;
              (a.lineWidth = 1),
                Le(L, L + e, r + l / 2, l - 3 + o.barChunk, s.black),
                Le(L, L + e, r + l / 2, l - 3, s.grey),
                Le(
                  L,
                  L + e * _.skill.getProgress(),
                  r + l / 2,
                  l - 3.5,
                  s.gold
                ),
                f.class.draw(
                  "Level " + _.skill.getLevel() + " " + F[_.type].name,
                  L + e / 2,
                  r + l / 2,
                  l - 4,
                  s.guiwhite,
                ...
                Le(L + 0.1 * e, L + 0.9 * e, r + l / 2, l - 3, s.grey),
                Le(
                  L + 0.1 * e,
                  L +
                    e *
                      (0.1 +
                        0.8 * (w ? Math.min(1, _.skill.getScore() / w) : 1)),
                  r + l / 2,
                  l - 3.5,
                  s.green
                ),
                f.score.draw(
                  "Score: " +
                    (t.died
                      ? n.formatLargeNumber(Math.round(t.finalScore.get()))
                      : n.formatLargeNumber(Math.round(_.skill.getScore()))),
                  L + e / 2,
                  r + l / 2,
                  l - 2,
                  s.guiwhite,
                ...
                f.name.draw(
                  t.player.name,
                  Math.round(L + e / 2) + 0.5,
                  Math.round(r - 10 - 4) + 0.5,
                  32,
                  t.player.nameColor,
                  "center"
                );
            }
            {
              let e = D[0].length,
                ...
                n = 1;
              l > e && (L = e / l), e > l && (n = l / e);
              let r = M * t.screenWidth,
                c = r * L,
                h = r * n,
                w = t.screenWidth - c - 20,
                F = t.screenHeight - h - 20,
                y = 66,
                b = 0;
              a.globalAlpha = 0.5;
              for (let L = 0; L < D.length; L++) {
                ...
                for (let L = 0; L < t.length; L++)
                  (a.fillStyle = v(t[L], 0)),
                    J(w + (n++ * c) / e, F + (b * h) / l, c / e, h / l);
                b++;
              }
              (a.fillStyle = s.grey),
                o.roundedUI ? Q(w, F, c, h, 10) : J(w, F, c, h);
              for (let l = 0, L; l < S.length; l++)
                if (((L = S[l]), 17 === L[2]))
                  (a.fillStyle = d(p(L[2]), s.black, 0.5)),
                    (a.globalAlpha = 0.8),
                    ee(
                      w + (L[0] / t.gameWidth) * c,
                      F + (L[1] / t.gameHeight) * h,
                      1
                    );
                else if (16 === L[2] || 18 === L[2]) {
                  (a.strokeStyle = s.black),
                    (a.lineWidth = 1),
                    (a.fillStyle = d(p(16), s.black, 0.5)),
                    (a.globalAlpha = 0.8);
                  let e = 16 === L[2] ? 4 : 1,
                    l = w + (L[0] / t.gameWidth) * c - e,
                    n = F + (L[1] / t.gameHeight) * h - e;
                  16 === L[2] ? J(l, n, 6.75, 6.75) : $(l, n, 2);
                } else
                  (a.fillStyle = d(p(L[2]), s.black, 0.5)),
                    (a.lineWidth = 1),
                    (a.globalAlpha = 1),
              ...
              (a.globalAlpha = 1),
                (a.lineWidth = 1),
                (a.strokeStyle = s.black),
                (a.fillStyle = p(t.player.color)),
                t.died ||
                  $(
                    w + (t.player.x / t.gameWidth) * c - 1,
                    F + (t.player.y / t.gameWidth) * c - 1,
                    2
                  ),
                (a.lineWidth = 4),
                (a.fillStyle = s.black),
                o.roundedUI ? Q(w, F, c, h, 10, 0, 1) : J(w, F, c, h, 1),
                t.debug &&
                  !t.died &&
                  (J(w, F - 40, c, 30),
                  g(W.get(), w, F - 40, c, 30, s.teal),
                  u(P.rendergap, w, F - 40, c, 30, s.pink),
                  m(k, w, F - 40, c, 30, s.yellow),
                  (F -= 40)),
                t.debug &&
                  !t.died &&
                  ((y = 94),
                  f.debug[4].draw(
                    "Prediction: " + Math.round(k) + "ms",
                    w + c,
                    F - 78,
                    10,
                    s.guiwhite,
                ...
                f.debug[2].draw(
                  "Client FPS: " + P.rendertime,
                  w + c,
                  F - 50,
                  10,
                  15 < P.rendertime ? s.guiwhite : s.orange,
                  "right"
                ),
                f.debug[1].draw(
                  (t.died ? "Server Speed (Standby): " : "Server Speed: ") +
                    (100 * _.fps).toFixed(2) +
                    "%",
                  w + c,
                  F - 22,
                  10,
                  1 === _.fps ? s.guiwhite : s.orange,
                  "right"
                ),
                f.debug[3].draw(
                  ...
                  F - 36,
                  10,
                  200 > P.latency ? s.guiwhite : s.orange,
                  "right"
                ),
                f.debug[0].draw(
                  t.servers[t.selectedServer].location,
                  w + c,
                  F - 8,
                  10,
                  s.guiwhite,
                ...
                (t.fps = P.rendertime || 20);
            }
            {
              let e = M * t.screenWidth,
                l = 14,
                L = t.screenWidth - e - 20,
                a = 41;
              f.lbtitle.draw(
                "Leaderboard:",
                Math.round(L + e / 2) + 0.5,
              ...
              let r = 0;
              for (let i = 0, d; i < A.data.length; i++) {
                (d = A.data[i]),
                  Le(L, L + e, a + 7, 11 + o.barChunk, s.black),
                  Le(L, L + e, a + 7, 11, s.grey);
                let c = Math.min(1, d.score / w);
                Le(L, L + e * c, a + 7, l - 3.5, d.barcolor),
                  f.leaderboard[r++].draw(
                    d.label + ": " + n.handleLargeNumber(Math.round(d.score)),
                    L + e / 2,
                    a + 7,
                    9,
                    d.nameColor,
                ...
                let h = l / d.position.axis,
                  m = L - 21 - 0.707 * (h * d.position.middle.x),
                  g = a + 7 + 0.707 * (h * d.position.middle.x);
                t.tag ||
                  (d.label.includes("Trans Rights") && (d.image.color = 212),
                  d.label.includes("4NAX") && (d.image.color = 6),
                  be(
                    m,
                    g,
                    d.image,
            ...
            {
              l.set(0 + (t.canUpgrade || t.upgradeHover));
              let e = l.get();
              if ((t.clickables.upgrade.hide(), 0 < _.upgrades.length)) {
                t.canUpgrade = 1;
                let l = 10,
                  L = 20 * (2 * e) - 20,
                  n = t.tankMenuColor,
                  ...
                  h = i,
                  g = 0,
                  u = (M * t.screenWidth) / 2.05,
                  y = u;
                I += 0.01;
                for (let m = 0; m < _.upgrades.length; m++) {
                  if (
                    (i > h && (h = i - 60),
                    (c = 2 * L + 105),
                    t.clickables.upgrade.place(r++, i, L, u, y),
                    (a.globalAlpha = 0.5),
                    (a.fillStyle = p(185 < n ? n - 85 : n)),
                    o.roundedUI ? Q(i, L, u, y, 10) : J(i, L, u, y),
                    (a.globalAlpha = 0.175),
                    (a.fillStyle = p(-10 + (n++ - (185 < n ? 85 : 0)))),
                    o.roundedUI ? Q(i, L, u, 0.6 * y, 4) : J(i, L, u, 0.6 * y),
                    (a.fillStyle = s.black),
                    o.roundedUI
                      ? Q(i, L + 0.6 * y, u, 0.4 * y, 4)
                      : J(i, L + 0.6 * y, u, 0.4 * y),
                    !t.died && !t.disconnected)
                  ) {
                    let e = Math.pow(
                        t.target.x / t.pixelRatio +
                          t.screenWidth / 2 -
                          (i + y / 2),
                        2
                      ),
                      l = Math.pow(
                        t.target.y / t.pixelRatio +
                          t.screenHeight / 2 -
                          (L + u / 2),
                        2
                      );
                    Math.sqrt(e + l) < 0.55 * y &&
                      (o.roundedUI ? Q(i, L, u, y, 10) : J(i, L, u, y),
                      (a.globalAlpha = 0.5));
                  }
                  a.globalAlpha = 1;
                  let v = _.upgrades[m],
                    ...
                    w = F[v].position,
                    E = (0.6 * u) / w.axis,
                    x = i + 0.5 * y - E * w.middle.x * Math.cos(I),
                    S = L + 0.5 * u - E * w.middle.x * Math.sin(I);
                  be(x, S, k, 1, 1, E / k.size, I, 1),
                    f.upgradeNames[r - 1].draw(
                      k.name,
                      i + u / 2,
                      L + y - 6,
                      y / 8 - 3,
                    ...
                    (a.globalAlpha = 1),
                    (a.lineWidth = 3),
                    o.roundedUI ? Q(i, L, u, y, 8, 0, 1) : J(i, L, u, y, 1),
                    0 == ++g % (o.useFourRows ? 4 : 3)
                      ? ((L = d), (i += y + l))
                      : (L += e * (u + l));
                }
                let v = j("Ignore", 11) + 10,
                  m = h + y + 10,
                  k = (c + u + 10 + d - 15) / 2;
                Le(m - v / 2, m + v / 2, k + 7, 14 + o.barChunk, s.black),
                  Le(m - v / 2, m + v / 2, k + 7, 14, s.white),
                  f.skipUpgrades.draw(
                    "Ignore",
                    m,
                    k + 7,
                  ...
                  t.clickables.skipUpgrades.place(0, m - v / 2, k, v, 14);
              } else
                (t.canUpgrade = 0),
                  t.clickables.upgrade.hide(),
                  t.clickables.skipUpgrades.hide();
            }
            "high" === o.quality &&
              (a.scale(
        ...
        Se = (() => {
          let e = {
            ...
            l = () => {
              let e = [
                  Math.round(t.finalKills[0].get()),
                  Math.round(t.finalKills[1].get()),
                  Math.round(t.finalKills[2].get())
                ],
                l = e[0] + 0.5 * e[1] + 3 * e[2];
              return (
                (0 === l
                ...
                (e[0] || e[1] || e[2]
                  ? " " +
                    (e[0] ? e[0] + " kill" + (1 === e[0] ? "" : "s") : "") +
                    (e[0] && e[1] ? " and " : "") +
                    (e[1] ? e[1] + " assist" + (1 === e[1] ? "" : "s") : "") +
                    ((e[0] || e[1]) && e[2] ? " and " : "") +
                    (e[2]
                      ? e[2] + " boss" + (1 === e[2] ? "" : "es") + " defeated"
                      : "")
                  : " A true pacifist") +
                "."
              );
            ...
            L = () => {
              let e = "";
              if (t.finalKillers.length) {
                e = "\uD83D\uDD2A Succumbed to";
                for (let l = 0; l < t.finalKillers.length; l++)
                  e += " " + n.addArticle(F[t.finalKillers[l]].name) + " and";
                e = e.slice(0, -4) + ".";
              } else e += "\uD83D\uDD2A Well that was kinda dumb, huh?";
              return e;
            };
          return () => {
            N(s.black, 0.25);
            let a = t.screenWidth / 2,
              r = t.screenHeight / 2 - 50,
              o = b(_.type, _.color),
              i = F[_.type].position,
              d = 140 / i.axis,
              c = t.screenWidth / 2 - 0.707 * (d * i.middle.x),
              h = t.screenHeight / 2 - 35 + 0.707 * (d * i.middle.x),
              m = Math.ceil((t.diedAt + 3e3 - Date.now()) / 1e3);
            be(
              c - 190 - 70,
              h - 10,
              o,
              ...
              e.taunt.draw(
                t.deathSplash[t.deathSplashChoice],
                a,
                r - 80,
                11,
                s.guiwhite,
              ...
              e.time.draw(
                "\u231A Survived for " +
                  n.formatTime(Math.round(t.finalLifetime.get())) +
                  ".",
                a - 170,
                r + 55,
                16,
              ...
              e.kills.draw(l(), a - 170, r + 77, 16, s.guiwhite),
              e.death.draw(L(), a - 170, r + 99, 16, s.guiwhite),
              e.playagain.draw(
                0 < m
                  ? "You may respawn in " +
                      m +
        ...
        Ie = (() => {
          let e = { connecting: V(), message: V() },
            l = t.tipSplash[Math.floor(Math.random() * t.tipSplash.length)];
          return () => {
            N(s.white, 0.5),
              e.connecting.draw(
                "Connecting...",
        ...
        Te = (() => {
          let e = { disconnected: V(), message: V() };
          return () => {
            let l = t.arenaClosed ? s.yellow : s.red,
              L = t.died ? 120 : 0;
            N(d(l, s.guiblack, 0.3), 0.25),
              e.disconnected.draw(
                "\uD83D\uDC80 Disconnected \uD83D\uDC80",
                t.screenWidth / 2,
                t.screenHeight / 2 + L,
              ...
              t.arenaClosed &&
                e.message.draw(
                  t.closingSplash[t.closingSplashChoice],
                  t.screenWidth / 2,
                  t.screenHeight / 2 + 45 + L,
                  15,
                  l,
                  "center"
                );
        ...
        ze = () => {
          (t.animLoopHandle = window.requestAnimFrame(ze)),
            (t.player.renderv += (t.player.view - t.player.renderv) / 30);
          let e = o.screenshotMode ? 2 : B();
          (a.lineCap = "round"),
            (a.lineJoin = "round"),
            (a.filter = "none"),
            t.gameStart &&
              ...
              ((t.time = Y()),
              1e3 < t.time - M &&
                (t.socket.ping(t.time),
                (M = t.time),
                (P.rendertime = C),
                (C = 0),
                (P.updatetime = A),
                (A = 0)),
              (P.lag = t.time - t.player.time)),
            t.gameStart ? xe(e) : !t.disconnected && Ie(),
            t.died && (t.clearUpgrades(), Se()),
            t.disconnected && Te();
        };
    },
    function(e) {
      e.exports = {
        ...
        KEY_SPECTATE_FORWARD: 221,
        KEY_SPECTATE_BACKWARD: 219,
        KEY_STEALTH: 74,
        KEY_HORDE: 73,
        ...
        tipSplash: [
          ...
          "Don't like the new miter edges look of Woomy-Arras.io? Try the Use Rounded Edges option.",
        ...
        closingSplash: [
          ...
          "http://woomy-arras.io/img/unfixable.png",
          "There were many sightings of Xyv throughout the numerous wars.",
          "Tanks that manage to survive The Arena Closers get ensnared in The Perfect Sphere.",
          "The Puppeteer knows where you are at all times, but it's been split into fragments, the mind broken to prevent it from coming back.",
          "Reanimated Tanks come back to life from the force that started it all.",
          "GET DOWN ON YOUR INSECT HOOVES AND WORSHIP SCIENCE YOU FILTHY DOGS",
          "YOU WENT OFF DEAD WITH YOUR BIG GUN FIRE HAND",
          "The Fiery Gun Hand stole the plans.",
          "The plans are fragmented by layers.",
          "The Hemispheres know about the layers.",
          "Are you a Hemisphere? Think about it."
        ],
    ...
    function(e, l) {
      (l.submitToLocalStorage = e => (
        ...
        (l.retrieveFromLocalStorage = e => (
          (document.getElementById(e).value = localStorage.getItem(
            e + "Value"
          )),
        ...
        (l.handleLargeNumber = e => {
          ...
          return l && 0 == e
            ...
            : e < Math.pow(10, 18)
            ? (e / Math.pow(10, 15)).toFixed(2) + "qd"
            : e < Math.pow(10, 21)
            ? (e / Math.pow(10, 18)).toFixed(2) + "qt"
            : e < Math.pow(10, 24)
            ? (e / Math.pow(10, 21)).toFixed(2) + "sx"
            : e < Math.pow(10, 27)
            ? (e / Math.pow(10, 24)).toFixed(2) + "sp"
            : e < Math.pow(10, 30)
            ? (e / Math.pow(10, 27)).toFixed(2) + "o"
            : e < Math.pow(10, 33)
            ? (e / Math.pow(10, 30)).toFixed(2) + "n"
            : 1e38 < e
            ? "Infinity"
            : isNaN(e)
            ? "NaN"
            : (e / Math.pow(10, 33)).toFixed(2) + "d";
        }),
        (l.formatTime = e => {
          let l = e % 60;
          (e /= 60), (e = Math.floor(e));
          ...
          return (
            ...
            r(L, "minute"),
            r(l, "second"),
            "" == n && (n = "less than a second"),
            n
          );
        }),
        (l.addArticle = e =>
          /[aeiouxAEIOUX]/.test(e[0]) ? "an " + e : "a " + e),
        (l.formatLargeNumber = e =>
      ...
      class a {
        constructor() {
          ...
          (this.cv = document.getElementById("gameCanvas")),
            (this.cv.width = t.screenWidth),
            (this.cv.height = t.screenHeight),
            ...
            switch (e.keyCode) {
              case t.KEY_ENTER:
                if (
                  ...
                  return;
                t.died && this.parent.socket.talk("s", t.playerName, 0),
                  (t.died = !1),
                  setTimeout(() => (t.resetMenuColor = !1), 20);
                break;
              case t.KEY_UP_ARROW:
              ...
              case t.KEY_LEFT_ARROW:
                if (!t.died && t.showTree)
                  return (t.scrollX -= 0 >= t.scrollX ? 0 : 0.0045);
              case t.KEY_LEFT:
                this.parent.socket.cmd.set(2, 1);
                break;
              case t.KEY_RIGHT_ARROW:
                if (!t.died && t.showTree)
                  return (t.scrollX += 1 <= t.scrollX ? 0 : 0.0045);
              case t.KEY_RIGHT:
              ...
              case t.KEY_UPGRADE_COLOR:
                if (t.died) break;
                185 <= t.tankMenuColor && (t.tankMenuColor = 100),
                  (t.tankMenuColor += 1);
                break;
            ...
            if (!e.repeat)
              switch (e.keyCode) {
                ...
                case t.KEY_CLASS_TREE:
                  if (t.died) break;
                  (t.showTree = !t.showTree),
                    this.parent.socket.talk("P", t.showTree);
                  break;
                case t.KEY_TESTBED:
                ...
                case t.KEY_TANK_JOURNEY:
                  ...
                  break;
                case t.KEY_SPECTATE_FORWARD:
                  this.parent.socket.talk("A", 1);
                  break;
                case t.KEY_SPECTATE_BACKWARD:
                  this.parent.socket.talk("A", 2);
                  break;
                case t.KEY_STEALTH:
              ...
              case 0:
                {
                  let l = { x: e.clientX, y: e.clientY },
                    L = t.clickables.stat.check(l);
                  if (-1 !== L) this.parent.socket.talk("x", L);
                  else if (-1 !== t.clickables.skipUpgrades.check(l))
                    t.clearUpgrades();
                  else {
                    let e = t.clickables.upgrade.check(l);
                    -1 === e
                      ? this.parent.socket.cmd.set(4, 1)
                      : this.parent.socket.talk("U", e);
                  }
                }
                break;
              case 1:
        ...
        gameInput(e) {
          (this.parent.target.x = e.clientX * t.pixelRatio - t.player.cx),
            (this.parent.target.y = e.clientY * t.pixelRatio - t.player.cy),
            (t.target = this.parent.target),
            (t.statHover =
              0 === t.clickables.hover.check({ x: e.clientX, y: e.clientY }));
        }
      }
      e.exports = a;
    },
    function(e, l) {
      let L = new Uint32Array(1),
      ...
      (l.encode = e => {
          ...
          if (0 === t || !1 === t) a = 0;
            ...
            !Number.isInteger(t) || -4294967296 > t || 4294967296 <= t
              ...
              ? 256 > t
                ...
                : 65536 > t
                ? ((a = 4), (s += 2))
                : 4294967296 > t && ((a = 6), (s += 4))
              : -256 <= t
              ? ((a = 3), s++)
              : -65536 <= t
              ? ((a = 5), (s += 2))
              : -4294967296 <= t && ((a = 7), (s += 4));
          else if ("string" == typeof t) {
            let e = !1;
            for (let l = 0; l < t.length; l++)
              if ("\xFF" < t.charAt(l)) e = !0;
              else if ("\0" === t.charAt(l))
            ...
            throw (console.error("Unencodable data type!", t),
            new Error("Unencodable data type!"));
          if ((l.push(a), a === i)) d++;
          else {
            if ((o.push(i), 1 <= d)) {
              for (; 19 < d; ) o.push(14), o.push(15), (d -= 19);
              1 === d
                ? o.push(i)
                : 2 === d
                ? o.push(12)
        ...
        o.push(15), 1 == o.length % 2 && o.push(15);
        let c = new Uint8Array((o.length >> 1) + s);
        ...
        for (let o = 0, s; o < l.length; o++)
          switch (((s = e[o]), l[o])) {
            ...
            case 9:
              ...
              break;
            case 10:
              for (let e = 0; e < s.length; e++) c[h++] = s.charCodeAt(e);
              c[h++] = 0;
              break;
            case 11:
              for (let e = 0, l; e < s.length; e++)
                (l = s.charCodeAt(e)), (c[h++] = 255 & l), (c[h++] = l >> 8);
              (c[h++] = 0), (c[h++] = 0);
          }
        return c;
      }),
          ...
          for (;;) {
            ...
            if ((c ? ((e &= 15), d++) : (e >>= 4), (c = !c), 12 == (12 & e))) {
              ...
              if (14 === e) {
                if (d >= l.length) return null;
                let e = l[d];
                c ? ((e &= 15), d++) : (e >>= 4), (c = !c), (L += e);
              }
              for (let e = 0; e < L; e++) o.push(s);
            } else o.push(e), (s = e);
          }
          let h = [];
          for (let s = 0, i; s < o.length; s++)
            switch (((i = o[s]), i)) {
              case 0:
                h.push(0);
                break;
              ...
              case 3:
                ...
                break;
              case 4:
                (r[0] = l[d++]), (r[1] = l[d++]), h.push(n[0]);
                break;
              case 5:
                (r[0] = l[d++]), (r[1] = l[d++]), h.push(n[0] - 65536);
                break;
              case 6:
                (t[0] = l[d++]),
                  (t[1] = l[d++]),
              ...
              case 10:
                {
                  let e = "",
                    L = 0;
                  for (; (L = l[d++]); ) e += String.fromCharCode(L);
                  h.push(e);
                }
                break;
              case 11: {
